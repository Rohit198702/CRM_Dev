    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                if (msg.Trim() == "ER02")
                {
                    Utility.ShowMessage_Error(this, "Country already exists !!");
                    return;
                }
                ...
                if (ddlCountry.SelectedIndex > 0)
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmCountry.aspx", "update", ddlCountry.SelectedValue);
                    Bind_Controls();
                    Reset();
                }
                else
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmCountry.aspx", "Save", msg);
                    Bind_Controls();
                    Reset();
                }
            }
