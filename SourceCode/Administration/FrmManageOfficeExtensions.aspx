              ...
              <div class="row pt-3">
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            <label>E-Mail</label>
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmail" onchange="return validateEmail(this)" autocomplete="off" MaxLength="50" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                            <div class="form-group">
