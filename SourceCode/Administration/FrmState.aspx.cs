    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                if (msg.Trim() == "ER02")
                {
                    Utility.ShowMessage_Error(this, "State already exists !!");
                    return;
                }
                ...
                if (ddlState.SelectedIndex > 0)
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmState.aspx", "Update", ddlState.SelectedValue);
                    Bind_Controls();
                ...
                else
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmState.aspx", "save", msg);
                    Bind_Controls();
                    Bind_State(Convert.ToInt32(ddlCountryState.SelectedValue));
                    Reset();
                }
