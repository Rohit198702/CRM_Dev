...
namespace BLLAERO
{
    public class BLLManageTriflexInvoice
    {
        // this one is for only login
        private DALManageTriflexInvoice ObjDAL = new DALManageTriflexInvoice();
        public DataSet GetInvoice(BOLTriflexInvoice ObjBOL)
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.GetInvoice(ObjBOL);
            return ds;
        }
        ...
        {
            string Status = "";
            Status = ObjDAL.SaveInvoice(ObjBOL);
            return Status;
        }

    }
    public class BLLManageInvoice
    {
        // this one is for only login
        private DALManageInvoice ObjDAL = new DALManageInvoice();
    ...
    public class BLLSheetMetal
    {
        private DALSheetMetal ObjDAL = new DALSheetMetal();
        ...
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.Return_JobConsumptionDataSet(ObjBOL);
            return ds;
        }
        public String Return_JobConsumptionString(BOLSheetMetal ObjBOL)
        {
            String Status = "";
            Status = ObjDAL.Return_JobConsumptionString(ObjBOL);
            return Status;
        }
        public DataSet Return_ReportDataSet(BOLSheetMetal ObjBOL)
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.Return_ReportDataSet(ObjBOL);
            return ds;
        }
        public DataSet Return_ForecastReportDataSet(BOLSheetMetal ObjBOL)
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.Return_ForecastReportDataSet(ObjBOL);
            return ds;
        }
        //Return_LiveReportDataSet
        public DataSet Return_LiveReportDataSet(BOLSheetMetal ObjBOL)
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.Return_LiveReportDataSet(ObjBOL);
            return ds;
        }
        public DataSet Return_SheetMetalReportDataSet(BOLSheetMetal ObjBOL)
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.Return_SheetMetalReportDataSet(ObjBOL);
            return ds;
        }
        public DataSet Return_SheetMetalPOReportDataSet(BOLSheetMetal ObjBOL)
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.Return_SheetMetalPOReportDataSet(ObjBOL);
            return ds;
        }
    }
    public class BLLActivityMonthlyReview
    {
        private DALActivityMonthlyReview ObjDAL = new DALActivityMonthlyReview();
    ...
    public class BLLBDMActivity
    {
        private DALBDMActivity ObjDAL = new DALBDMActivity();
    ...
    public class BLLSalesActivity_V1
    {
        private DALSalesActivity_V1 ObjDAL = new DALSalesActivity_V1();
    ...
    public class BLLApprovedDwgAndFollowup
    {
        private DALApprovedDwgAndFollowup ObjDAL = new DALApprovedDwgAndFollowup();
    ...
    public class BLLManageDepartment
    {
        // this one is for only login
        private DALManageDepartment ObjDAL = new DALManageDepartment();
        public DataSet GetDepartment(BOLManageDepartment ObjBOL)
        {
            DataSet ds = new DataSet();
            ds = ObjDAL.GetDepartment(ObjBOL);
            return ds;
        }
        ...
        {
            string Status = "";
            Status = ObjDAL.SaveDepartment(ObjBOL);
            return Status;
        }

    }
    public class BLLNestingEmail
    {
        private DALNestingEmail ObjDAL = new DALNestingEmail();
    ...
    public class BLLWeeklyInstallations
    {
        private DALWeeklyInstallations ObjDAL = new DALWeeklyInstallations();
    ...
    public class BLLMafsiRegionDetailMaintenance
    {
        private DALMafsiRegionDetailMaintenance ObjDAL = new DALMafsiRegionDetailMaintenance();
    ...
    public class BLLMafsiRegionMaintenance
    {
        private DALMafsiRegionMaintenance ObjDAL = new DALMafsiRegionMaintenance();
    ...
    public class BLLStockAllocation
    {
        private DALStockAllocation ObjDAL = new DALStockAllocation();
    ...
    public class BLLDailyPurchaseDepartment
    {
        private DALDailyPurchaseDepartment ObjDAL = new DALDailyPurchaseDepartment();
    ...
    {
        private DALLoginDetails ObjDAL = new DALLoginDetails();
    ...
    public class BLLOpportunitiesReport
    {
        private DALOpportunitiesReport ObjDAL = new DALOpportunitiesReport();
    ...
    public class BLLProposalSearch
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = ObjDALProposalSearch.GetAdvancedProposalSearch(ObjBOLProposalSearch);
            return ds;
        }
    }
