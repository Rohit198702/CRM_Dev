...
namespace DALAERO
{
    public class DALManageTriflexInvoice : Connection
    {
        public string SaveInvoice(BOLTriflexInvoice ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[18];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@InvoiceNo", ObjBOL.InvoiceNo);
            param[2] = new SqlParameter("@Date", ObjBOL.Date);
            param[3] = new SqlParameter("@operation", ObjBOL.operation);
            param[4] = new SqlParameter("@ProjectNo", ObjBOL.ProjectNo);
            param[5] = new SqlParameter("@ProjectName", ObjBOL.ProjectName);
            param[6] = new SqlParameter("@To", ObjBOL.To);
            param[7] = new SqlParameter("@Address", ObjBOL.Address);
            param[8] = new SqlParameter("@GSTNo", ObjBOL.GSTNo);
            param[9] = new SqlParameter("@Telephone", ObjBOL.Telephone);
            param[10] = new SqlParameter("@Attention", ObjBOL.Attention);
            param[11] = new SqlParameter("@ItemName", ObjBOL.ItemName);
            param[12] = new SqlParameter("@Qty", ObjBOL.Qty);
            param[13] = new SqlParameter("@UnitPrice", ObjBOL.UnitPrice);
            param[14] = new SqlParameter("@Freight", ObjBOL.Freight);
            param[15] = new SqlParameter("@GSTPercentage", ObjBOL.GSTPercentage);
            param[16] = new SqlParameter("@InvoiceID", ObjBOL.InvoiceID);
            param[17] = new SqlParameter("@AssemblyandInstallation", ObjBOL.AssemblyandInstallation);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageTriflexInvoice", param);
            string msg = param[0].Value.ToString();
            return msg;
        }

        public DataSet GetInvoice(BOLTriflexInvoice ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@InvoiceID", ObjBOL.InvoiceID);
            param[2] = new SqlParameter("@operation", ObjBOL.operation);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "aero_ManageTriflexInvoice", param);
            return ds;
        }
    }


    public class DALManageInvoice : Connection
    {
        public string SaveInvoice(BOLManageInvoice ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[12];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@InvoiceID", ObjBOL.InvoiceID);
            param[2] = new SqlParameter("@InvoiceNo", ObjBOL.InvoiceNo);
            param[3] = new SqlParameter("@operation", ObjBOL.operation);
            param[4] = new SqlParameter("@InvoiceDate", ObjBOL.InvoiceDate);
            param[5] = new SqlParameter("@TechnicalDwg", ObjBOL.TechnicalDwg);
            param[6] = new SqlParameter("@JobDwg", ObjBOL.JobDwg);
            param[7] = new SqlParameter("@FabDwg", ObjBOL.FabDwg);
            param[8] = new SqlParameter("@Total", ObjBOL.Total);
            param[9] = new SqlParameter("@AWSCharges", ObjBOL.AWSCharges);
            param[10] = new SqlParameter("@SupportCharges", ObjBOL.SupportCharges);
            param[11] = new SqlParameter("@InvoicePeriod", ObjBOL.InvoicePeriod);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageInvoice", param);
            string msg = param[0].Value.ToString();
            return msg;
        }

        public DataSet GetInvoice(BOLManageInvoice ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@InvoiceID", ObjBOL.InvoiceID);
            param[2] = new SqlParameter("@operation", ObjBOL.operation);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "aero_ManageInvoice", param);
            return ds;
        }

    }
    public class DALSheetMetal : Connection
    {
        public DataSet Return_DataSet(BOLSheetMetal ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[9];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@id", ObjBOL.id);
            param[2] = new SqlParameter("@productcodeid", ObjBOL.productcodeid);
            param[3] = new SqlParameter("@POId", ObjBOL.POId);
            // PODetailID
            param[4] = new SqlParameter("@PODetailID", ObjBOL.PODetailID);
            param[5] = new SqlParameter("@StockOutID", ObjBOL.StockOutID);
            param[6] = new SqlParameter("@UserId", ObjBOL.LoginUserID);
            param[7] = new SqlParameter("@warehouseid", ObjBOL.warehouseid);
            param[8] = new SqlParameter("@SheetDetailID", ObjBOL.SheetDetailID);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal]", param);
            return ds;
        }



        public string Return_String(BOLSheetMetal ObjBOL)
        {
            ...
            param[2] = new SqlParameter("@productcodeid", ObjBOL.productcodeid);
            param[3] = new SqlParameter("@warehouseid", ObjBOL.warehouseid);
            param[4] = new SqlParameter("@sheetmetalid", ObjBOL.sheetmetalid);
            param[5] = new SqlParameter("@sheetmetaldesc", ObjBOL.sheetmetaldesc);
            param[6] = new SqlParameter("@gauge", ObjBOL.gauge);
            param[7] = new SqlParameter("@length", ObjBOL.length);
            param[8] = new SqlParameter("@width", ObjBOL.width);
            param[9] = new SqlParameter("@minqty", ObjBOL.minqty);
            param[10] = new SqlParameter("@maxqty", ObjBOL.maxqty);
            param[11] = new SqlParameter("@currentstock", ObjBOL.currentstock);
            param[12] = new SqlParameter("@leadtime", ObjBOL.leadtime);
            param[13] = new SqlParameter("@qtyonskid", ObjBOL.qtyonskid);
            param[14] = new SqlParameter("@id", ObjBOL.id);
            param[15] = new SqlParameter("@date", ObjBOL.date);
            param[16] = new SqlParameter("@quantity", ObjBOL.quantity);
            param[17] = new SqlParameter("@UserId", ObjBOL.LoginUserID);
            param[18] = new SqlParameter("@TransactQty", ObjBOL.TransactQuantity);
            param[19] = new SqlParameter("@ReceiptNo", ObjBOL.ReceiptNo);
            param[20] = new SqlParameter("@DeliveryDate", ObjBOL.DeliveryDate);
            param[21] = new SqlParameter("@DeliveryQuantity", ObjBOL.DeliveryQuantity);
            param[22] = new SqlParameter("@DeliveryStatusId", ObjBOL.DeliveryStatus);
            param[23] = new SqlParameter("@PODetailID", ObjBOL.PODetailID);
            param[24] = new SqlParameter("@POId", ObjBOL.POId);
            param[25] = new SqlParameter("@StockOutID", ObjBOL.StockOutID);
            param[26] = new SqlParameter("@SheetMetalStatus", ObjBOL.SheetMetalStatus);
            param[27] = new SqlParameter("@TransactSummary", ObjBOL.TransactSummary);
            param[28] = new SqlParameter("@AdjustmentReasonID", ObjBOL.AdjustmentReasonID);
            param[29] = new SqlParameter("@SheetDetailID", ObjBOL.SheetDetailID);
            param[30] = new SqlParameter("@ExpectedArrivalDate", ObjBOL.ExpectedArrivalDate);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }

        public DataSet Return_JobConsumptionDataSet(BOLSheetMetal ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@ConsumptionID", ObjBOL.ConsumptionID);
            param[2] = new SqlParameter("@JobID", ObjBOL.JobID);
            param[3] = new SqlParameter("@ProductCodeID", ObjBOL.productcodeid);
            param[4] = new SqlParameter("@JobNo", ObjBOL.JobNo);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal_JobConsumption]", param);
            return ds;
        }
        public string Return_JobConsumptionString(BOLSheetMetal ObjBOL)
        {
            ...
            param[1] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[2] = new SqlParameter("@JobID", ObjBOL.JobID);            
            param[3] = new SqlParameter("@JobSheetMetalID", ObjBOL.JobSheetMetalID);
            param[4] = new SqlParameter("@TransactQty", ObjBOL.JobTransactQty);
            param[5] = new SqlParameter("@Date", ObjBOL.JobDate);
            param[6] = new SqlParameter("@ConsumptionID", ObjBOL.ConsumptionID);
            param[7] = new SqlParameter("@JobNo", ObjBOL.JobNo);
            param[8] = new SqlParameter("@ProductCodeID", ObjBOL.productcodeid);
            param[9] = new SqlParameter("@warehouseid", ObjBOL.warehouseid);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal_JobConsumption]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
        public DataSet Return_ReportDataSet(BOLSheetMetal ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@SheetMetalID", ObjBOL.id);
            param[2] = new SqlParameter("@WarehouseID", ObjBOL.warehouseid);
            param[3] = new SqlParameter("@JobNo", ObjBOL.JobNo);
            param[4] = new SqlParameter("@ProductCodeID", ObjBOL.productcodeid);
            param[5] = new SqlParameter("@FromDate", ObjBOL.FromDate);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal_JobReport]", param);
            return ds;
        }
        public DataSet Return_ForecastReportDataSet(BOLSheetMetal ObjBOL)
        {
            ...
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal_ForecastData]", param);
            return ds;
        }
        public DataSet Return_LiveReportDataSet(BOLSheetMetal ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[4];               
            param[0] = new SqlParameter("@FromDate", ObjBOL.FromDate);
            param[1] = new SqlParameter("@ToDate", ObjBOL.ToDate);
            param[2] = new SqlParameter("@SheetMetalID", ObjBOL.id);
            param[3] = new SqlParameter("@WarehouseID", ObjBOL.warehouseid);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal_LiveStock]", param);
            return ds;
        }
        public DataSet Return_SheetMetalReportDataSet(BOLSheetMetal ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[7];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@SheetDetailID", ObjBOL.id);
            param[2] = new SqlParameter("@gaugeid", ObjBOL.gauge);
            param[3] = new SqlParameter("@lengthid", ObjBOL.length);
            param[4] = new SqlParameter("@widthid", ObjBOL.width);
            param[5] = new SqlParameter("@status", ObjBOL.SheetMetalStatus);
            param[6] = new SqlParameter("@warehouseid", ObjBOL.warehouseid);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal_GetReportData]", param);
            return ds;
        }
        public DataSet Return_SheetMetalPOReportDataSet(BOLSheetMetal ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[7];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@SheetMetalID", ObjBOL.id);
            param[2] = new SqlParameter("@gaugeid", ObjBOL.gauge);
            param[3] = new SqlParameter("@warehouseid", ObjBOL.warehouseid);
            param[4] = new SqlParameter("@POId", ObjBOL.POId);
            param[5] = new SqlParameter("@OrderDateFrom", ObjBOL.OrderDateFrom);
            param[6] = new SqlParameter("@OrderDateTo", ObjBOL.OrderDateTo);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageSheetMetal_POReport]", param);
            return ds;
        }        

    }
    public class DALActivityMonthlyReview : Connection
    {
        public DataSet Return_DataSet(BOLActivityMonthlyReview ObjBOL)
        {
            ...
            param[3] = new SqlParameter("@ReviewDate", ObjBOL.ReviewDate);
            param[5] = new SqlParameter("@OwnerUserId", ObjBOL.OwnerUserId);
            param[6] = new SqlParameter("@Accomplishment_1", ObjBOL.Accomplishment_1);
            param[4] = new SqlParameter("@Accomplishment_2", ObjBOL.Accomplishment_2);
            param[7] = new SqlParameter("@Gap_1", ObjBOL.Gap_1);
            param[8] = new SqlParameter("@StatusId", ObjBOL.StatusId);
            param[9] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[10] = new SqlParameter("@LoginUserId", ObjBOL.LoginUserId);
            param[11] = new SqlParameter("@Accomplishment_3", ObjBOL.Accomplishment_3);
            param[12] = new SqlParameter("@Gap_2", ObjBOL.Gap_2);
            param[13] = new SqlParameter("@QuarterId", ObjBOL.QuarterId);
            param[14] = new SqlParameter("@CorrectiveAction", ObjBOL.CorrectiveAction);

            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[aero_ManageActivityMonthlyReview]", param);
            return ds;
        }
        public string Return_String(BOLActivityMonthlyReview ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[15];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            ...
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ManageActivityMonthlyReview]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }

    public class DALBDMActivity : Connection
    {
        public DataSet Return_DataSet(BOLBDMActivity ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[60];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@Id", ObjBOL.Id);
            param[2] = new SqlParameter("@BDMId", ObjBOL.BDMId);
            param[3] = new SqlParameter("@ActivityId", ObjBOL.ActivityId);
            param[4] = new SqlParameter("@ActivityNo", ObjBOL.ActivityNo);
            param[5] = new SqlParameter("@ActivityTypeId", ObjBOL.ActivityTypeId);
            param[6] = new SqlParameter("@ActivityDate", ObjBOL.ActivityDate);
            param[7] = new SqlParameter("@Subject", ObjBOL.Subject);
            param[8] = new SqlParameter("@Discussion", ObjBOL.Discussion);
            param[9] = new SqlParameter("@BusinessOutcome", ObjBOL.BusinessOutcome);
            param[10] = new SqlParameter("@TeamPosted", ObjBOL.TeamPosted);
            param[11] = new SqlParameter("@TeamPostedDate", ObjBOL.TeamPostedDate);
            param[12] = new SqlParameter("@LocationTypeId", ObjBOL.LocationTypeId);
            param[13] = new SqlParameter("@VisitModeId", ObjBOL.VisitModeId);
            param[14] = new SqlParameter("@StatusId", ObjBOL.StatusId);
            param[15] = new SqlParameter("@CompanyIds", ObjBOL.CompanyIds);
            param[16] = new SqlParameter("@ContactIds", ObjBOL.ContactIds);
            param[17] = new SqlParameter("@IsPrimary", ObjBOL.IsPrimary);
            param[18] = new SqlParameter("@Remarks", ObjBOL.Remarks);
            param[19] = new SqlParameter("@SpecNo", ObjBOL.SpecNo);
            param[20] = new SqlParameter("@ProjectName", ObjBOL.ProjectName);
            param[21] = new SqlParameter("@CountryId", ObjBOL.CountryId);
            param[22] = new SqlParameter("@StateId", ObjBOL.StateId);
            param[23] = new SqlParameter("@City", ObjBOL.City);
            param[24] = new SqlParameter("@ProjectStageId", ObjBOL.ProjectStageId);
            param[25] = new SqlParameter("@PriorityId", ObjBOL.PriorityId);
            param[26] = new SqlParameter("@EstimatedValue", ObjBOL.EstimatedValue);
            param[27] = new SqlParameter("@Probability", ObjBOL.Probability);
            param[28] = new SqlParameter("@RiskLevelId", ObjBOL.RiskLevelId);
            param[29] = new SqlParameter("@Competitor", ObjBOL.Competitor);
            param[30] = new SqlParameter("@BusinessOpportunity", ObjBOL.BusinessOpportunity);
            param[31] = new SqlParameter("@CurrentIssue", ObjBOL.CurrentIssue);
            param[32] = new SqlParameter("@ApprovedDrawings", ObjBOL.ApprovedDrawings);
            param[33] = new SqlParameter("@OrderReceived", ObjBOL.OrderReceived);
            param[34] = new SqlParameter("@OrderValue", ObjBOL.OrderValue);
            param[35] = new SqlParameter("@ExpectedClosureDate", ObjBOL.ExpectedClosureDate);
            param[36] = new SqlParameter("@ClosedDate", ObjBOL.ClosedDate);
            param[37] = new SqlParameter("@FollowupNo", ObjBOL.FollowupNo);
            param[38] = new SqlParameter("@FollowupTypeId", ObjBOL.FollowupTypeId);
            param[39] = new SqlParameter("@FollowupDate", ObjBOL.FollowupDate);
            param[40] = new SqlParameter("@AssignedToId", ObjBOL.AssignedToId);
            param[41] = new SqlParameter("@DueDate", ObjBOL.DueDate);
            param[42] = new SqlParameter("@CompletedOn", ObjBOL.CompletedOn);
            param[43] = new SqlParameter("@ReminderDate", ObjBOL.ReminderDate);
            param[44] = new SqlParameter("@ReminderSent", ObjBOL.ReminderSent);
            param[45] = new SqlParameter("@LoginUserId", ObjBOL.LoginUserId);
            param[46] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[47] = new SqlParameter("@ParticipantTypeId", ObjBOL.ParticipantTypeId);
            param[48] = new SqlParameter("@Address", ObjBOL.Address);
            param[49] = new SqlParameter("@Details", ObjBOL.Details);
            param[50] = new SqlParameter("@MaterialUsed", ObjBOL.MaterialUsed);
            param[51] = new SqlParameter("@IndustryId", ObjBOL.IndustryId);
            param[52] = new SqlParameter("@NextActionDate", ObjBOL.NextActionDate);
            param[53] = new SqlParameter("@Duration", ObjBOL.Duration);
            param[54] = new SqlParameter("@NextAction", ObjBOL.NextAction);
            param[55] = new SqlParameter("@PNumber", ObjBOL.PNumber);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[aero_ManageBDMActivity]", param);
            return ds;
        }

        public string Return_String(BOLBDMActivity ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[60];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@Id", ObjBOL.Id);
            ...
            param[43] = new SqlParameter("@ReminderDate", ObjBOL.ReminderDate);
            param[44] = new SqlParameter("@ReminderSent", ObjBOL.ReminderSent);
            param[46] = new SqlParameter("@LoginUserId", ObjBOL.LoginUserId);
            param[47] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[48] = new SqlParameter("@ParticipantTypeId", ObjBOL.ParticipantTypeId);
            param[49] = new SqlParameter("@Address", ObjBOL.Address);
            param[50] = new SqlParameter("@MaterialUsed", ObjBOL.MaterialUsed);
            param[51] = new SqlParameter("@Details", ObjBOL.Details);
            param[52] = new SqlParameter("@IndustryId", ObjBOL.IndustryId);
            param[53] = new SqlParameter("@NextActionDate", ObjBOL.NextActionDate);
            param[54] = new SqlParameter("@Duration", ObjBOL.Duration);
            param[55] = new SqlParameter("@NextAction", ObjBOL.NextAction);
            param[56] = new SqlParameter("@PNumber", ObjBOL.PNumber);
            param[45] = new SqlParameter("@msg", SqlDbType.VarChar, 50);
            param[45].Direction = ParameterDirection.Output;
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ManageBDMActivity]", param);
            string msg = param[45].Value.ToString();
            return msg;
        }
    }

    public class DALApprovedDwgAndFollowup : Connection
    {
        public DataSet Return_DataSet(BOLApprovedDwgAndFollowup ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[14];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@FromDate", ObjBOL.FromDate);
            param[2] = new SqlParameter("@ToDate", ObjBOL.ToDate);
            param[3] = new SqlParameter("@DateCalled", ObjBOL.DateCalled);
            param[4] = new SqlParameter("@Contact", ObjBOL.Contact);
            param[5] = new SqlParameter("@Notes", ObjBOL.Notes);
            param[6] = new SqlParameter("@ID", ObjBOL.ID);
            param[7] = new SqlParameter("@ContactID", ObjBOL.ContactID);
            param[8] = new SqlParameter("@StatusId", ObjBOL.StatusId);
            param[9] = new SqlParameter("@JobId", ObjBOL.JobId);
            param[10] = new SqlParameter("@TimeStampCH", ObjBOL.TimeStampCH);
            param[11] = new SqlParameter("@ProjectManagerId", ObjBOL.ProjectManagerId);
            param[12] = new SqlParameter("@LoginUserId", ObjBOL.LoginUserId);
            param[13] = new SqlParameter("@FollowupBy", ObjBOL.FollowupBy);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[aero_ManageApprovedDwgAndFollowup]", param);
            return ds;
        }

        public string Return_String(BOLApprovedDwgAndFollowup ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[15];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@FromDate", ObjBOL.FromDate);
            ...
            param[9] = new SqlParameter("@JobId", ObjBOL.JobId);
            param[10] = new SqlParameter("@TimeStampCH", ObjBOL.TimeStampCH);
            param[12] = new SqlParameter("@ProjectManagerId", ObjBOL.ProjectManagerId);
            param[13] = new SqlParameter("@LoginUserId", ObjBOL.LoginUserId);
            param[14] = new SqlParameter("@FollowupBy", ObjBOL.FollowupBy);
            param[11] = new SqlParameter("@msg", SqlDbType.VarChar, 50);
            param[11].Direction = ParameterDirection.Output;
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ManageApprovedDwgAndFollowup]", param);
            string msg = param[11].Value.ToString();
            return msg;
        }
    }

    public class DALSalesActivity_V1:Connection
    {
        public DataSet Return_DataSet(BOLSalesActivity_V1 ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[2] = new SqlParameter("@SalesActivityID", ObjBOL.SalesActivityID);
            param[3] = new SqlParameter("@StakeHolderID", ObjBOL.StakeHolderID);
            param[4] = new SqlParameter("@PNumber", ObjBOL.PNumber);
            param[5] = new SqlParameter("@JobID", ObjBOL.JobID);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[aero_ManageSalesActivity_V1]", param);
            return ds;
        }
        public string Return_String(BOLSalesActivity_V1 ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[2];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@Operation", ObjBOL.Operation);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ManageSalesActivity_V1]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }
    public class DALManageDepartment : Connection
    {
        public string SaveDepartment(BOLManageDepartment ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@DepartmentID", ObjBOL.DepartmentID);
            param[2] = new SqlParameter("@DeptName", ObjBOL.DeptName);
            param[3] = new SqlParameter("@operation", ObjBOL.operation);       
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageDepartment", param);
            string msg = param[0].Value.ToString();
            return msg;
        }

        public DataSet GetDepartment(BOLManageDepartment ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@DepartmentID", ObjBOL.DepartmentID);
            param[2] = new SqlParameter("@operation", ObjBOL.operation);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "aero_ManageDepartment", param);
            return ds;
        }

    }

    public class DALNestingEmail : Connection
    {
        public DataSet Return_DataSet(BOLNestingEmail ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[3];
            ...
            param[1] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[2] = new SqlParameter("@JobID", ObjBOL.JobID);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[Get_AutoEmail_NT_ReleaseOnHold]", param);            
            return ds;
        }
        public string Return_String(BOLNestingEmail ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 50);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[2] = new SqlParameter("@JobID", ObjBOL.JobID);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[Get_AutoEmail_NT_ReleaseOnHold]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }
    public class DALWeeklyInstallations:Connection
    {
        public DataSet Return_DataSet(BOLWeeklyInstallments ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[2];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@searchvar", ObjBOL.searchvar);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[Get_ProjectInstallationStatusReport]", param);
            return ds;
        }
    }
    public class DALMafsiRegionDetailMaintenance : Connection
    {
        public DataSet Return_DataSet(BOLMafsiRegionDetailMaintenance ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[7];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@Id", ObjBOL.Id);
            ...
            param[6] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[aero_ManageMafsiRegionDetail]", param);
            return ds;
        }

        public string Return_String(BOLMafsiRegionDetailMaintenance ObjBOL)
        {
            ...
            param[7] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ManageMafsiRegionDetail]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }

    public class DALMafsiRegionMaintenance : Connection
    {
        public DataSet Return_DataSet(BOLMafsiRegionMaintenance ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[7];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@Id", ObjBOL.Id);
            param[2] = new SqlParameter("@RegionName", ObjBOL.RegionName);
            param[3] = new SqlParameter("@RegionNo", ObjBOL.RegionNo);
            param[4] = new SqlParameter("@Status", ObjBOL.Status);
            param[5] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[6] = new SqlParameter("@SortOrder", ObjBOL.SortOrder);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[aero_ManageMafsiRegion]", param);
            return ds;
        }

        public string Return_String(BOLMafsiRegionMaintenance ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[8];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 50);
            param[0].Direction = ParameterDirection.Output;
            ...
            param[5] = new SqlParameter("@Status", ObjBOL.Status);
            param[6] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[7] = new SqlParameter("@SortOrder", ObjBOL.SortOrder);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ManageMafsiRegion]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }

    public class DALStockAllocation : Connection
    {
        public DataSet Return_DataSet(BOLStockAllocation ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@UserId", ObjBOL.UserId);            
            param[2] = new SqlParameter("@PartList", ObjBOL.PartList);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_StockAllocation]", param);
            return ds;
        }

        public string Return_String(BOLStockAllocation ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 50);
            param[0].Direction = ParameterDirection.Output;
            ...
            param[3] = new SqlParameter("@PartList", ObjBOL.PartList);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[IV].[Inv_StockAllocation]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }

    public class DALDailyPurchaseDepartment : Connection
    {
        public DataSet Return_DataSet(BOLDailyPurchaseDepartment ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@Id", ObjBOL.Id);
            param[2] = new SqlParameter("@Department", ObjBOL.Department);
            param[3] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[aero_ManageDailyPurchaseDepartment]", param);
            return ds;
        }

        public string Return_String(BOLDailyPurchaseDepartment ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[6];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 50);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[2] = new SqlParameter("@Id", ObjBOL.Id);
            param[3] = new SqlParameter("@Department", ObjBOL.Department);
            param[4] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ManageDailyPurchaseDepartment]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }

    public class DALLoginDetails : Connection
    {
        public string SaveLogs(BOLLoginDetails ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[12];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@Userid", ObjBOL.UserId);
            param[2] = new SqlParameter("@IPAddress", ObjBOL.IPAddress);
            param[3] = new SqlParameter("@MacAddress", ObjBOL.MacAddress);
            param[4] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[5] = new SqlParameter("@BrowserInfo", ObjBOL.BrowserInfo);
            param[6] = new SqlParameter("@Location", ObjBOL.Location);
            param[7] = new SqlParameter("@CountryName", ObjBOL.CountryName);
            param[8] = new SqlParameter("@CityName", ObjBOL.CityName);
            param[9] = new SqlParameter("@RegionName", ObjBOL.RegionName);
            param[10] = new SqlParameter("@Username", ObjBOL.Username);
            param[11] = new SqlParameter("@Password", ObjBOL.Password);
    ...
    public class DALOpportunitiesReport : Connection
    {
        public DataSet Return_DataSet(BOLOpportunitiesReport ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@fromdate", ObjBOL.FromDate);
            param[1] = new SqlParameter("@todate", ObjBOL.ToDate);
            param[2] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[3] = new SqlParameter("@DestRep", ObjBOL.DestRep);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[dbo].[Get_OpportunitiesReport]", param);
            return ds;
        }
    }
    public class DALGaylordProjects : Connection
    {
        public DataSet Return_DataSet(BOLGaylordProjects ObjBOL)
        {
            ...
            param[28] = new SqlParameter("@NestingStartDate", ObjBOL.NestingStartDate);
            param[29] = new SqlParameter("@NestingEndDate", ObjBOL.NestingEndDate);
            param[30] = new SqlParameter("@NestingSentDate", ObjBOL.NestingSentDate);
            param[31] = new SqlParameter("@NestingStatusId", ObjBOL.NestingStatusId);
            param[32] = new SqlParameter("@ReleaseToNesting", ObjBOL.ReleaseToNesting);
            param[33] = new SqlParameter("@RefId", ObjBOL.RefId);
            param[34] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
        ...
        public string Return_String(BOLGaylordProjects ObjBOL)
        {
            ...
            param[29] = new SqlParameter("@NestingStartDate", ObjBOL.NestingStartDate);
            param[30] = new SqlParameter("@NestingEndDate", ObjBOL.NestingEndDate);
            param[31] = new SqlParameter("@NestingSentDate", ObjBOL.NestingSentDate);
            param[32] = new SqlParameter("@NestingStatusId", ObjBOL.NestingStatusId);
            param[33] = new SqlParameter("@ReleaseToNesting", ObjBOL.ReleaseToNesting);
            param[34] = new SqlParameter("@RefId", ObjBOL.RefId);
            param[35] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
    ...
    public class DALInstallers : Connection
    {
        ...
        public string Return_String(BOLInstallers ObjBOL)
        {
            ...
            param[18] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[19] = new SqlParameter("@TimeStampDetail", ObjBOL.TimeStampDetail);
    ...
    public class DALProjectsFabricationAndNestingTasks : Connection
    {
        public DataSet Return_DataSet(BOLProjectsFabricationAndNestingTasks ObjBOL)
        {
            ...
            param[16] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[17] = new SqlParameter("@FileName", ObjBOL.FileName);
        ...
        public string Return_String(BOLProjectsFabricationAndNestingTasks ObjBOL)
        {
            ...
            param[17] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[18] = new SqlParameter("@FileName", ObjBOL.FileName);
    ...
    public class DALShippingHistory : Connection
    {
        public DataSet Return_DataSet(BOLShippingHistory ObjBOL)
        {
            ...
            param[7] = new SqlParameter("@ModelList", string.Join(",", ObjBOL.ModelList ?? new string[0]));
            param[8] = new SqlParameter("@DealerID", ObjBOL.DealerID);
            param[9] = new SqlParameter("@ProjectName", ObjBOL.ProjectName);
            param[10] = new SqlParameter("@ShippedVia", ObjBOL.ShippedVia);
    ...
    public class DALShopDwgIssueLog : Connection
    {
        public DataSet Return_DataSet(BOLManageShopDwgIssueLog ObjBOL)
        {
            ...
            param[20] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[21] = new SqlParameter("@TimeStampDetail", ObjBOL.TimeStampDetail);
    ...
    public class DALDailyPurchaseParts : Connection
    {
        public DataSet Return_DataSet(BOLDailyPurchaseParts ObjBOL)
        {
            ...
            param[13] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[14] = new SqlParameter("@DepartmentId", ObjBOL.DepartmentId);
        ...
        public string Return_String(BOLDailyPurchaseParts ObjBOL)
        {
            ...
            param[14] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[15] = new SqlParameter("@DepartmentId", ObjBOL.DepartmentId);
    ...
    public class DALDailyPurchase : Connection
    {
        public DataSet Return_DataSet(BOLDailyPurchase ObjBOL)
        {
            ...
            param[7] = new SqlParameter("@DepartmentId", ObjBOL.DepartmentId);
            ...
            param[19] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[20] = new SqlParameter("@LoginUserId", ObjBOL.LoginUserId);
        ...
        public string Return_String(BOLDailyPurchase ObjBOL)
        {
            ...
            param[20] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[21] = new SqlParameter("@LoginUserId", ObjBOL.LoginUserId);
    ...
    public class DALSalesActivity : Connection
    {
        ...
        public string Return_String(BOLSalesActivity ObjBOL)
        {
            ...
            param[23] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[24] = new SqlParameter("@TimeStampFollowUps", ObjBOL.TimeStampFollowUps);
    ...
    public class DALStockInHandAdjustment : Connection
    {
        public DataSet Return_DataSet(BOLStockInHandAdjustment ObjBOL)
        {
            ...
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_StockInHand_AdjustmentQty]", param);
            return ds;
        }
        public string Return_String(BOLStockInHandAdjustment ObjBOL)
        {
            ...
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[IV].[Inv_StockInHand_AdjustmentQty]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }
    ...
    public class DALPostInstallFollowups : Connection
    {
        ...
        public string Return_String(BOLPostInstallFollowups ObjBOL)
        {
            ...
            param[11] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
    ...
    public class DALEmployeeMaintain : Connection
    {
        ...
        public String SaveEmployeeRecord(BOLEmployeeMaintain ObjBOL)
        {
            ...
            param[29] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
    ...
    public class DALManageProjects_New : Connection
    {
        ...
        {
            SqlParameter[] param = new SqlParameter[235];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@JobID", ObjBOL.JobID);
            ...
            param[183] = new SqlParameter("@Plumbing", ObjBOL.Plumbing);             
            param[184] = new SqlParameter("@Electrical", ObjBOL.Electrical);
            param[185] = new SqlParameter("@InstallationStatus", ObjBOL.InstallationStatus);
            //param[187] = new SqlParameter("@ScopeDate", ObjBOL.ScopeDate);
            param[186] = new SqlParameter("@Osha", ObjBOL.Osha);
            param[187] = new SqlParameter("@OshaDetails", ObjBOL.OshaDetails);
            param[188] = new SqlParameter("@StateCertificate", ObjBOL.StateCertificate);
            param[189] = new SqlParameter("@StateCertificateDetails", ObjBOL.StateCertificateDetails);
            param[190] = new SqlParameter("@DrugTestingCertificate", ObjBOL.DrugTestingCertificate);
            param[191] = new SqlParameter("@DrugTestingCertificateDetails", ObjBOL.DrugTestingCertificateDetails);
            param[192] = new SqlParameter("@WHMIS", ObjBOL.WHMIS);
            param[193] = new SqlParameter("@WHMISDetails", ObjBOL.WHMISDetails);
            param[194] = new SqlParameter("@FallProtection", ObjBOL.FallProtection);
            param[195] = new SqlParameter("@FallProtectionDetails", ObjBOL.FallProtectionDetails);
            param[196] = new SqlParameter("@MedicalCertificate", ObjBOL.MedicalCertificate);
            param[197] = new SqlParameter("@MedicalCertificateDetails", ObjBOL.MedicalCertificateDetails);
            param[198] = new SqlParameter("@InsuranceCertificate", ObjBOL.InsuranceCertificate);
            param[199] = new SqlParameter("@InsuranceCertificateDetails", ObjBOL.InsuranceCertificateDetails);
            param[200] = new SqlParameter("@SiteContactEmail", ObjBOL.SiteContactEmail);
            param[201] = new SqlParameter("@ShipperContactName", ObjBOL.ShipperContactName);
            param[202] = new SqlParameter("@ShipperPhone", ObjBOL.ShipperPhone);
            param[203] = new SqlParameter("@ShipperEmail", ObjBOL.ShipperEmail);
            param[204] = new SqlParameter("@ShipperTrackingNo", ObjBOL.ShipperTrackingNo);
            param[205] = new SqlParameter("@ShipperPickupFromShop", ObjBOL.ShipperPickupFromShop);
            param[206] = new SqlParameter("@ShipperNotes", ObjBOL.ShipperNotes);
            param[207] = new SqlParameter("@ActualShippingCost", ObjBOL.ActualShippingCost);
            param[208] = new SqlParameter("@AdditionalCharges", ObjBOL.AdditionalCharges);
            param[209] = new SqlParameter("@ShippedVia", ObjBOL.ShippedVia);
            param[210] = new SqlParameter("@SalesOpportunity", ObjBOL.SalesOpportunity);
            param[211] = new SqlParameter("@SalesOpportunityStatus", ObjBOL.SalesOpportunityStatus);
            param[212] = new SqlParameter("@ExpectedSalesDate", ObjBOL.ExpectedSalesDate);
            param[213] = new SqlParameter("@ThirdPartyInstaller", ObjBOL.ThirdPartyInstaller);
            param[214] = new SqlParameter("@InstallationAmount", ObjBOL.InstallationAmount);
            param[215] = new SqlParameter("@DeliveryDate", ObjBOL.DeliveryDate);
            param[216] = new SqlParameter("@CommReportOverride", ObjBOL.CommReportOverride);
            param[217] = new SqlParameter("@CommReportOverrideReason", ObjBOL.CommReportOverrideReason);
            param[218] = new SqlParameter("@TentativeEndDays", ObjBOL.TentativeEndDays);
            param[219] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[220] = new SqlParameter("@Timestamp_Proposal", ObjBOL.Timestamp_Proposal);
            param[221] = new SqlParameter("@Timestamp_Customer", ObjBOL.Timestamp_Customer);
            param[222] = new SqlParameter("@BusinessDivision", ObjBOL.BusinessDivision);

            param[223] = new SqlParameter("@Testing", ObjBOL.Testing);
            param[224] = new SqlParameter("@Commissioning", ObjBOL.Commissioning);
            param[225] = new SqlParameter("@CommissioningComments", ObjBOL.CommissioningComments);
            param[226] = new SqlParameter("@InstallationAssignedTo", ObjBOL.InstallationAssignedTo);
            param[227] = new SqlParameter("@EmailDescription", ObjBOL.EmailDescription);
            param[228] = new SqlParameter("@CalendarFileNames", ObjBOL.CalendarFileNames);
            param[229] = new SqlParameter("@PO_Installation", ObjBOL.PO_Installation);
            param[230] = new SqlParameter("@Invoice_Installation", ObjBOL.Invoice_Installation);
            param[231] = new SqlParameter("@Supervision", ObjBOL.Supervision);
        ...
        public DataSet GetProject(BOLManageProjects ObjBOL)
        {
            ...
            try
            {
                ...
                param[10] = new SqlParameter("@UserID", ObjBOL.UserID);
    ...
    public class DALManageProjectsEng : Connection
    {
        public string SaveProject(BOLManageProjects ObjBOL)
        {
            SqlParameter[] param = new SqlParameter[180];
            param[0] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@JobID", ObjBOL.JobID);
            param[2] = new SqlParameter("@JobOrderDate", ObjBOL.JobOrderDate);
            ...
            param[173] = new SqlParameter("@TempStatus", ObjBOL.TempStatus);
            param[174] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[175] = new SqlParameter("@DestinationFacility", ObjBOL.DestinationFacility);
            param[176] = new SqlParameter("@ExpectedArrivalCanadaDate", ObjBOL.ExpectedArrivalCanadaDate);
    ...
    public class DALWasteEq_New : Connection
    {
        ...
        public string Return_String(BOLWasteEq_New ObjBOL)
        {
            ...
            param[15] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[16] = new SqlParameter("@AccessoryRequired", ObjBOL.AccessoryRequired);
    ...
    public class DALProposalSearch : Connection
    {
        public DataSet GetProposalSearch(BOLProposalSearch ObjBOLProposalSearch)
        {
            ...
            param[5] = new SqlParameter("@dealerID", ObjBOLProposalSearch.dealerID);
            param[6] = new SqlParameter("@ConsultantID", ObjBOLProposalSearch.consultantID);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "aero_GetProposal", param);
            return ds;
        }

        public DataSet GetAdvancedProposalSearch(BOLProposalSearch ObjBOLProposalSearch)
        {
            SqlParameter[] param = new SqlParameter[5];
            param[0] = new SqlParameter("@msg", SqlDbType.Char, 50);
            param[0].Direction = ParameterDirection.Output;
            param[1] = new SqlParameter("@Operation", ObjBOLProposalSearch.Operation);
            param[2] = new SqlParameter("@SearchVar", ObjBOLProposalSearch.SearchVar);
            param[3] = new SqlParameter("@UserId", ObjBOLProposalSearch.UserId);
            param[4] = new SqlParameter("@UserInput", ObjBOLProposalSearch.UserInput);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "Get_AdvancedSearchProposal", param);
            return ds;
        }
    }
    ...
    public class DALManageProposals : Connection
    {
        ...
        public string SaveProposal(BOLManageProposals ObjBOL)
        {
            ...
            param[109] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[110] = new SqlParameter("@SpecID", ObjBOL.SpecID);
            param[111] = new SqlParameter("@Supervision", ObjBOL.Supervision);
        ...
        public DataSet GetProposal(BOLManageProposals ObjBOL)
        {
            ...
            try
            {
                ...
                param[2] = new SqlParameter("@PNumber", ObjBOL.PNumber);
                param[3] = new SqlParameter("@ConsultantID", ObjBOL.ConsultantID);
                param[4] = new SqlParameter("@PreviousPM", ObjBOL.PreviousPM);
                ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "aero_ManageProposals", param);
            }
            catch (Exception ex)
            {
    ...
    public class DALManageCustomerMember : Connection
    {
        public string SaveCustomerMember(BOLManageCustomerMember ObjBOL)
        {
            ...
            param[12] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageCustomers", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALManageConsultant : Connection
    {
        public string SaveConsultant(BOLManageConsultant ObjBOL)
        {
            ...
            param[22] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[23] = new SqlParameter("@TierClassification", ObjBOL.TierClassification);
    ...
    public class DALManageDealers : Connection
    {
        public string SaveDealers(BOLManageDealers ObjBOL)
        {
            ...
            param[27] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            param[28] = new SqlParameter("@TierClassification", ObjBOL.TierClassification);
    ...
    public class DALManageShipper : Connection
    {
        public string SaveShipper(BOLManageShippers ObjBOL)
        {
            ...
            param[12] = new SqlParameter("@operation", ObjBOL.operation);
            param[13] = new SqlParameter("@Timestamp", ObjBOL.TimeStamp);
            param[14] = new SqlParameter("@CountryId", ObjBOL.CountryId);
        ...
        public string SaveShipperMember(BOLManageShippers ObjBOL)
        {
            ...
            param[8] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[9] = new SqlParameter("@CellNo", ObjBOL.CellNo);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageShippers", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALINVPartsInfo : Connection
    {
        ...
        public DataSet GetJobs(BOLINVPartsInfo ObjBOL)
        {
            ...
            param[2] = new SqlParameter("@Operation", ObjBOL.operation);
            param[3] = new SqlParameter("@userid", ObjBOL.userid);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_StockTransactions_V1]", param);
            return ds;
        }
        //ReleaseProject
        ...
        public String StockAdjustment(BOLINVPartsInfo ObjBOL)
        {
            ...
            param[7] = new SqlParameter("@WarehouseId", ObjBOL.WarehouseId);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[IV].[Inv_StockTransactions_V1]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALINVParts : Connection
    {
        public DataSet GetPartsInfo(BOLPartMaintainanace ObjBOL)
        {
            ...
            param[8] = new SqlParameter("@PartTypeId", ObjBOL.PartTypeId);
        ...
        public String SaveINVPartsDetail(BOLPartMaintainanace ObjBOL)
        {
            ...
            param[34] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[35] = new SqlParameter("@PartTypeId", ObjBOL.PartTypeId);
        ...
        public String DeleteINVParts(BOLPartMaintainanace ObjBOL)
        {
            ...
            param[0] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[1] = new SqlParameter("@partid", ObjBOL.Partid);
            param[2] = new SqlParameter("@PartLookupID", ObjBOL.PartLookupID);
            param[3] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[4] = new SqlParameter("@msg", SqlDbType.VarChar, 500);
            param[4].Direction = ParameterDirection.Output;
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "INV_PartsMaintainance", param);
            string Msg = param[4].Value.ToString();
            return Msg;
        }
    ...
    public class DALCustCareTickets : Connection
    {
        ...
        public string SaveCustCareTicketDetail(BOLCustCareTickets ObjBOL)
        {
            ...
            param[36] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[37] = new SqlParameter("@DepartmentId", ObjBOL.DepartmentId);            
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageCustCareTickets", param);
            string msg = Convert.ToString(param[0].Value);
            return msg;
        }
        ...
        public string SaveCustCareTicketSummary(BOLCustCareTickets ObjBOL)
        {
            ...
            param[5] = new SqlParameter("@TimeStampDetails", ObjBOL.TimeStampDetails);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageCustCareTickets", param);
            string msg = Convert.ToString(param[0].Value);
            return msg;
        }
        public string DeleteTicketRecord(BOLCustCareTickets ObjBOL)
        {
            ...
            param[3] = new SqlParameter("@TimeStampDetails", ObjBOL.TimeStampDetails);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageCustCareTickets", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALRequisition : Connection
    {
        ...
        public string SaveRequisition(BOLRequisition ObjBOL)
        {
            ...
            param[20] = new SqlParameter("@MinUrgentQty", ObjBOL.MinUrgentQty);
            param[21] = new SqlParameter("@Options", ObjBOL.Options);
            param[22] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[23] = new SqlParameter("@TimeStampDetail", ObjBOL.TimeStampDetail);
            SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageRequisition]", param);
            string msg = Convert.ToString(param[0].Value);
            return msg;
        }
        public string DeleteRequisition(BOLRequisition ObjBOL)
        {
            ...
            param[6] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[7] = new SqlParameter("@TimeStampDetail", ObjBOL.TimeStampDetail);
            SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageRequisition]", param);
            string msg = Convert.ToString(param[0].Value);
            return msg;
        }
    ...
    public class DALManageShopEmployees : Connection
    {
        ...
        public string UpdateShopEmployees(BOLManageShopEmployees ObjBOL)
        {
            ...
            param[29] = new SqlParameter("@Phone", ObjBOL.Phone);
            param[30] = new SqlParameter("@EmployeeCurrentStatus", ObjBOL.EmployeeCurrentStatus);
            param[31] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageShopEmployees", param);
            string msg = param[0].Value.ToString();
            return msg;
        ...
        public string AddShopEmployeesTraining(BOLManageShopEmployees ObjBOL)
        {
            ...
            param[8] = new SqlParameter("@TimeStampTraining", ObjBOL.TimeStampTraining);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "aero_ManageShopEmployees", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALPreventativeMaintenanceCallLogs : Connection
    {
        public DataSet Return_DataSet(BOLPreventativeMaintenanceCallLogs ObjBOL)
        {
            ...
            param[12] = new SqlParameter("@TimeStampCH", ObjBOL.TimeStampCH);
            param[13] = new SqlParameter("@PMPrice", ObjBOL.PMPrice);
            param[14] = new SqlParameter("@AppointmentDate", ObjBOL.AppointmentDate);
            param[15] = new SqlParameter("@POReceived", ObjBOL.POReceived);
        ...
        public string Return_String(BOLPreventativeMaintenanceCallLogs ObjBOL)
        {
            ...
            param[13] = new SqlParameter("@TimeStampCH", ObjBOL.TimeStampCH);
            param[14] = new SqlParameter("@AppointmentDate", ObjBOL.AppointmentDate);
            param[15] = new SqlParameter("@POReceived", ObjBOL.POReceived);
            param[16] = new SqlParameter("@PMPrice", ObjBOL.PMPrice);
            param[11] = new SqlParameter("@msg", SqlDbType.VarChar, 50);
            param[11].Direction = ParameterDirection.Output;
    ...
    public class DALManageSerProjcts : Connection
    {
        ...
        public string SaveSerProjects(BOLSerProjects ObjBOL)
        {
            ...
            param[25] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "Service_Projects", param);
            string msg = Convert.ToString(param[0].Value);
            return msg;
        }
    ...
    public class DALManageRepGroup : Connection
    {
        public string SaveRepGroup(BOLManageRepGroup ObjBOL)
        {
            ...
            param[10] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
    ...
    public class DALServiceSchedule : Connection
    {
        ...
        public string SavePack(BOLServiceSchedule ObjBOL)
        {
            ...
            param[22] = new SqlParameter("@TimeStampDetail", ObjBOL.TimeStampDetail);
        ...
        public string DeletePackNoDetail(BOLServiceSchedule ObjBOL)
        {
            ...
            param[1] = new SqlParameter("@Operation", ObjBOL.Operation);
            param[2] = new SqlParameter("@Id", ObjBOL.ID);
            param[3] = new SqlParameter("@TimeStampDetail", ObjBOL.TimeStampDetail);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[dbo].[aero_ServiceSchedule]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALPurchaseOrderManual : Connection
    {
        ...
        public string SavePurchaseOrderInfoAndDetail(BOLPurchaseOrder ObjBOL)
        {
            ...
            param[17] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[18] = new SqlParameter("@ShipmentMethod", ObjBOL.ShipmentMethod);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManagePurchaseOrderManual_V1]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALPreventiveMaintenance : Connection
    {
        public string SaveAndUpdate(BOLPreventiveMaintenance ObjBOL)
        {
            ...
            param[21] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[22] = new SqlParameter("@TimeStampDetail", ObjBOL.TimeStampDetail);
    ...
    public class DALManageSearchPO : Connection
    {
        ...
        public DataSet GetSearchReportData(BOLSearchPO ObjBOL)
        {
            ...
            param[4] = new SqlParameter("@PartID", ObjBOL.PartID);
            param[5] = new SqlParameter("@SourceID", ObjBOL.SourceID);
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Get_POReport]", param);
            return ds;
        }
    }
    ...
    public class DALManageSearchContainer : Connection
    {
        ...
        public string DeletePOData(BOLSearchContainer ObjBOL)
        {
            ...
            param[2] = new SqlParameter("@POId", ObjBOL.POId);
            param[3] = new SqlParameter("@EmployeeID", ObjBOL.EmployeeID);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[IV].[Inv_PurchaseOrder_Delete]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    }
    ...
    public class DALManageCADDYENGTasks : Connection
    {
        ...
        public string SaveEngTaskDetails(BOLCADDYENGTasks ObjBOL)
        {
            ...
            param[19] = new SqlParameter("@RecFromCustomer", ObjBOL.RecFromCustomer);
            param[20] = new SqlParameter("@FwdToCustomer", ObjBOL.FwdToCustomer);
            param[21] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
    ...
    public class DALStockIn_New : Connection
    {
        public DataSet Return_DataSet(BOLStockIn_New ObjBOL)
        {
            ...
            param[7] = new SqlParameter("@DestWarehouseID", ObjBOL.DestWarehouseID);            
            DataSet ds = SqlHelper1.ExecuteDataset(con, CommandType.StoredProcedure, "[IV].[Inv_ManageStockInNew_V1]", param);
            return ds;
        }
        ...
        public string Return_String(BOLStockIn_New ObjBOL)
        {
            ...
            param[10] = new SqlParameter("@TimeStamp", ObjBOL.TimeStamp);
            param[11] = new SqlParameter("@TimeStampETA", ObjBOL.TimeStampETA);
            SqlHelper1.ExecuteNonQuery(con, CommandType.StoredProcedure, "[IV].[Inv_ManageStockInNew_V1]", param);
            string msg = param[0].Value.ToString();
            return msg;
        }
    ...
    public class DALManageITWProjects : Connection
    {
        public DataSet Return_DataSet(BOLManageITWProjects ObjBOL)
        {
            ...
            param[28] = new SqlParameter("@ReleaseToNesting", ObjBOL.ReleaseToNesting);
            param[29] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
        ...
        public string Return_String(BOLManageITWProjects ObjBOL)
        {
            ...
            param[29] = new SqlParameter("@ReleaseToNesting", ObjBOL.ReleaseToNesting);
            param[30] = new SqlParameter("@Timestamp", ObjBOL.Timestamp);
