    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
            <div class="col-12 pt-2 piDiv position-sticky">
                ...
                <div class="row">
                    ...
                    <div class="col-sm col-md col-lg col-xl-auto">
                        <div class="row">
                            <div class="col-auto">                               
                                <asp:Button ID="btnGenerateReport" runat="server" CssClass="btn btn-secondary btn-sm" Text="Daily Report" OnClick="btnGenerateReport_Click" CausesValidation="false" OnClientClick="window.document.forms[0].target='_blank';" />
            ...
            <div class="col-12 border-3">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-4 chosenFullWidth">
                        ...
                        <asp:Panel ID="JobName" runat="server" Style="height: 200px; overflow: scroll; display: none;">
                        </asp:Panel>
            ...
            <div class="col-12 border-top">
                <div class="row pt-3">
                    <div class="col-12">
                        <h5 class="text-uppercase">Task Information
                             <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success btn-sm mt-2" Text="Save" OnClick="btnSave_Click" />
                            <asp:Button ID="btnCancelInfo" runat="server" CssClass="btn btn-danger btn-sm mt-2" Text="Cancel" OnClick="btnCancelInfo_Click" />
                        </h5>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2" id="dvItemNo" runat="server">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2" id="dvModelType" runat="server">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlNatureOfTask" CssClass="form-control form-control-sm" autocomplete="off" runat="server" DataValueField="ID" DataTextField="NatureofTask">
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group">
                            <label>Date Req. Rec. from Customer</label>
                            <asp:TextBox ID="txtRecFromCustomer" CssClass="form-control form-control-sm" autocomplete="off" runat="server" OnBlur="validateDate(this)">
                            </asp:TextBox>
                            <asp:CalendarExtender ID="txtRecFromCustomer_Extender" runat="server" Format="MM/dd/yyyy"
                                PopupButtonID="txtRecFromCustomer" TargetControlID="txtRecFromCustomer">
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtFwdToCustomer" CssClass="form-control form-control-sm" autocomplete="off" runat="server" OnBlur="validateDate(this)">
                            </asp:TextBox>
                            <asp:CalendarExtender ID="txtFwdToCustomer_Extender" runat="server" Format="MM/dd/yyyy"
                                PopupButtonID="txtFwdToCustomer" TargetControlID="txtFwdToCustomer">
                            </asp:CalendarExtender>
                        </div>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvCadEngTasks" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ForeColor="Black" GridLines="Vertical" Width="100%" Style="font-size: small" CssClass="table mainGridTable table-sm" OnRowDeleting="gvCadEngTasks_RowDeleting" DataKeyNames="EngTaskID, TimeStamp" OnRowEditing="gvCadEngTasks_RowEditing">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Req. Rec. from Customer" DataField="RecFromCustomer" DataFormatString="{0:MM/dd/yyyy}" />                                   
                                    ...
                                    <asp:BoundField HeaderText="Sent To Customer" DataField="FwdToCustomer" DataFormatString="{0:MM/dd/yyyy}" />
                                    ...
                                    <asp:TemplateField HeaderText="Modify" ItemStyle-Width="7%">
                                        <ItemTemplate>
