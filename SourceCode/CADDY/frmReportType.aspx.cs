...
public partial class CADDY_frmReportType : System.Web.UI.Page
{
    ...
    private void GenReport_Caddy_Excel()
    {
        try
        {
            DataTable dt = new DataTable();
    ...
    private void GenReportHood_Excel()
    {
        try
        {
            DataTable dt = new DataTable();
    ...
    private void GenReportHood_Caddy_Excel()
    {
        try
        {
            DataTable dt = new DataTable();
