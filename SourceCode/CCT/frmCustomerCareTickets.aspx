                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlDepartment" CssClass="form-control form-control-sm" DataTextField="Department" DataValueField="DepartmentID" runat="server"></asp:DropDownList>
                            </div>
                            <div class="form-group d-flex flex-column">
                                <label>Conveyor Model</label>
                                <asp:Label ID="txtConveyorModel" CssClass="boldtext"  runat="server"></asp:Label>
                            </div>
                        </div>
                    ...
                    <div class="row pt-3">
                        <div class="col-12">
                            <div class="table-responsive">
                                <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvSummary" runat="server" AutoGenerateColumns="False" DataKeyNames="TicketID,TimeStamp"
