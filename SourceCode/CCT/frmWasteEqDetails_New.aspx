            ...
            <div class="col-12">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label>JobID</label>
                            <asp:DropDownList ID="ddlJobID" runat="server" DataValueField="JobID" CssClass="w-100" DataTextField="JobID" AutoPostBack="true" OnSelectedIndexChanged="ddlJobID_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtShipDate" runat="server" CssClass="form-control form-control-sm" Enabled="false"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group srRadiosBtns">
                            <label>Accessory Required</label>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="form-group">
                            <label>Remarks</label>
                            <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" onkeypress="return limitMultiLineInputLength(this, 500)" CssClass="form-control form-control-sm"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row border-top pt-3">
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <asp:GridView CssClass="table mainGridTable table-sm mb-0" ShowFooter="false" ID="gvWasteEqDetails" DataKeyNames="id,TimeStamp" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Accessory Required">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAccRequired" runat="server" Text='<%# Eval("Acc_Req") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="300px" />
                                    </asp:TemplateField>
