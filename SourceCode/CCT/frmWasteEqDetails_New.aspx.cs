...
public partial class CCT_frmWasteEqDetails_New : System.Web.UI.Page
{
    ...
    protected void gvWasteEqDetails_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            string TimeStamp = Convert.ToString(gvWasteEqDetails.DataKeys[e.NewEditIndex].Values[1]);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (dt.Rows[0]["JobID"].ToString().Trim() != "")
                {
                    ...
                    GetShipDate(ddlJobID.SelectedValue);
                }     
                if(dt.Rows[0]["AccessoryRequired"].ToString() == "0")
                {
                    rdbAssessoryReq.SelectedValue = "0";
                }
                else if(dt.Rows[0]["AccessoryRequired"].ToString() == "1")
                {
                    rdbAssessoryReq.SelectedValue = "1";
                }
                ...
                HfTimeStamp.Value = dt.Rows[0]["TimeStamp"].ToString();
            }
            btnSave.Text = "Update";
        }
        catch (Exception ex)
    ...
    protected void gvWasteEqDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            string TimeStamp = Convert.ToString(gvWasteEqDetails.DataKeys[e.RowIndex].Values[1]);
    ...
    private void btnSave_Click_Event()
    {
        try
        {
            ...
            ObjBOL.AccessoryRequired = Convert.ToInt32(rdbAssessoryReq.SelectedValue);
    ...
    private void GetShipDate(string JobID)
    {
        try
        {
