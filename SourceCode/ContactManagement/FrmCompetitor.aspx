    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-5">
                        <div class="row">
                            <div class="col-12 mb-3">
                                <label class="mb-0">Competitor</label>
                            </div>
                            <div class="col-sm mb-3">
                                <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlCompetitor" runat="server" DataTextField="CompetitorName" DataValueField="CompetitorID" 
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlCompetitor_SelectedIndexChanged"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="col-2">
            ...
            <div class="col-12 pt-3">
                <div class="row">
                    <div class="col-12">
                        <h5 class="text-uppercase mb-3">Competitor Details</h5>
                    </div>
                    <div class="col-12">
