    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                if (msg.Trim() == "ER02")
                {
                    Utility.ShowMessage_Error(this, "Competitor already exists !!");
                    return;
                }
                ...
                if (ddlCompetitor.SelectedIndex > 0)
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmCompetitor.aspx", "update", ddlCompetitor.SelectedValue);
                    Bind_Controls();
                    Reset();
                }
                else
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmCompetitor.aspx", "Save", msg);
                    Bind_Controls();
                    Reset();
                }
            }
