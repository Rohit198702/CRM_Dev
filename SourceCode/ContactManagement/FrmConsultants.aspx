...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="col-sm col-md col-lg col-xl-auto">
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <asp:Button ID="btnMafsiRedirect" runat="server" CssClass="btn btn-secondary btn-sm" OnClick="btnMafsiRedirect_Click" Text="Performance Report" />
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <asp:GridView CssClass="table mainGridTable table-sm" ID="gvMember" runat="server" AutoGenerateColumns="False"
                                DataKeyNames="ConsultantMemberID,timestamp" AllowPaging="True"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="First Name*">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtFName" runat="server" Text='<%# Eval("FirstName") %>' CssClass="form-control form-control-sm"></asp:TextBox>
                                        </EditItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Last Name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtLName" runat="server" Text='<%# Eval("LastName") %>' CssClass="form-control form-control-sm"></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Job Title">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtTitle" runat="server" Text='<%# Eval("JobTitle") %>' CssClass="form-control form-control-sm"></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Extension">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtExtension" runat="server" Text='<%# Eval("TelephoneExtension") %>' CssClass="form-control form-control-sm"></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Direct Line">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtDirect" runat="server" MaxLength="50" onblur="phoneMask(this)" Text='<%# Eval("DirectLine") %>' CssClass="form-control form-control-sm"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Email">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEmail" runat="server" onchange="return validateEmail(this)" Text='<%# Eval("Email") %>' CssClass="form-control form-control-sm"></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEditStatus" runat="server" Text='<%# Eval("MemberStatus") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            ...
                                            <asp:Label ID="lblUpdateStatus" runat="server" Text='<%# Eval("Status") %>' Visible="false"></asp:Label>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                    </asp:TemplateField>
                        ...
                        <div>
                            <table border="1" cellpadding="0" cellspacing="0" class="table mainGridTable table-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmail" onchange="return validateEmail(this)" runat="server" /></td>
                                    <td>
                                        <asp:DropDownList ID="ddlMemberStatus" runat="server" CssClass="form-control form-control-sm">
                                            <asp:ListItem>Select</asp:ListItem>
                                    ...
                                    <td>
                                        <asp:Button CssClass="btn btn-info btn-sm rounded" ID="btnAddMember" runat="server" Text="Add Contact" OnClick="btnAddMember_Click" />
                                    </td>
                                </tr>
                            </table>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function BindDrp() {
            ...
            $('#<%=ddlMemberStatus.ClientID%>').chosen();
