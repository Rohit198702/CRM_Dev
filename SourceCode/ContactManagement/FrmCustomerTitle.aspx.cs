        ...
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                if (ddlFrmCustomerTitle.SelectedIndex > 0)
                {
                    ...
                    if (msg.Trim() == "ER02")
                    {
                        Utility.ShowMessage_Error(this, "Title already exists !!");
                        return;
                    }

                    hfCusId.Value = ddlFrmCustomerTitle.SelectedValue;
                    Utility.ShowMessage_Success(this, "Record updated successfully !!");
                    Utility.MaintainLogsSpecial("FrmCustomerTitle.aspx", "update", ddlFrmCustomerTitle.SelectedValue);
                    Bind_Controls();
                    Reset();
                }
                else
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmCustomerTitle.aspx", "Save", msg);
                    Bind_Controls();
                    Reset();
                }
            }
