                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <asp:GridView ID="gvMember" CssClass="table mainGridTable table-sm" runat="server" AutoGenerateColumns="False"
                                DataKeyNames="ContactID,timestamp" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Email">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEmail" runat="server" onchange="return validateEmail(this)" MaxLength="50" Text='<%# Eval("email") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                    </asp:TemplateField>
                        ...
                        <div class="table-responsive">
                            <table cellpadding="0" cellspacing="0" class="table mainGridTable table-sm" border="1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmail" onchange="return validateEmail(this)" MaxLength="50" AutoComplete="off" runat="server" /></td>
                                    <td>
