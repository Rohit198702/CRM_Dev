...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
                    ...
                    <div class="col-sm-7 col-md-8 col-lg-6 col-xl-6">
                        <div class="row">
                            <div class="col-sm-auto col-md-auto mb-3">
                                <label class="mb-0">Dealers</label>
                            </div>
                    ...
                    <div class="col-sm col-md col-lg col-xl-auto">
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <asp:Button ID="btnMafsiRedirect" runat="server" CssClass="btn btn-info btn-sm" OnClick="btnMafsiRedirect_Click" Text="Performance Report" />
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlTierClassification" runat="server">
                                <asp:ListItem Value="">Select</asp:ListItem>
                                <asp:ListItem Value="1">1 / Strategic</asp:ListItem>
                                <asp:ListItem Value="2">2 / Growth</asp:ListItem>
                                <asp:ListItem Value="3">3 / Emerging</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <asp:GridView CssClass="table mainGridTable table-sm" ID="gvMember" runat="server" AutoGenerateColumns="False"
                                DataKeyNames="ContactID,Timestamp" AllowPaging="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Email">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control form-control-sm" onchange="return validateEmail(this)" MaxLength="40" Text='<%# Eval("email") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Status*">
                                        <ItemTemplate>
                                            <asp:Label ID="lblContactStatus" runat="server" Text='<%# Eval("contactStatus") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="ddlMemberContactStatus" runat="server" CssClass="form-control form-control-sm">
                                                <asp:ListItem>Select</asp:ListItem>
                                                <asp:ListItem Value="1">Active</asp:ListItem>
                                                <asp:ListItem Value="2">Quit</asp:ListItem>
                                                <asp:ListItem Value="3">Retired</asp:ListItem>
                                                <asp:ListItem Value="4">Temp. Leave</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:Label ID="lblMemberContactStatus" runat="server" Text='<%# Eval("MemberStatus") %>' Visible="false"></asp:Label>
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                        ...
                        <div>
                            <table class="table mainGridTable table-sm" border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmail" runat="server" onchange="return validateEmail(this)" MaxLength="40" autocomplete="off" />
                                    </td>
                                    <td>
                                        <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlContactStatus" runat="server">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem Value="1" Selected="True">Active</asp:ListItem>
                                            <asp:ListItem Value="2">Quit</asp:ListItem>
                                            <asp:ListItem Value="3">Retired</asp:ListItem>
                    ...
                    <div class="overflow-auto h-100">
                        <div class="col-12" style="position: sticky; top: 0; z-index: 107; background: white; padding: 10px;">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <asp:Button ID="btnHeadOfficeUpdate" CssClass="btn btn-success btn-sm" CausesValidation="false" runat="server" Text="Update" OnClick="btnHeadOfficeUpdate_Click"></asp:Button>
                                        <asp:Button ID="btnHeadOfficeCancel" CssClass="btn btn-danger btn-sm" CausesValidation="false" runat="server" Text="Cancel" OnClick="btnHeadOfficeCancel_Click"></asp:Button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="row pt-3">
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group chosenFullWidth">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlHeadOfficeStateAbb" DataValueField="StateID" DataTextField="Sabb" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlHeadOfficeStateAbb_SelectedIndexChanged"></asp:DropDownList>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group chosenFullWidth">
                                            <label>Tier classification</label>
                                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlTierClassificationHeader" runat="server">
                                                <asp:ListItem Value="">Select</asp:ListItem>
                                                <asp:ListItem Value="1">1 / Strategic</asp:ListItem>
                                                <asp:ListItem Value="2">2 / Growth</asp:ListItem>
                                                <asp:ListItem Value="3">3 / Emerging</asp:ListItem>
                                            ...
                                            <asp:GridView CssClass="table mainGridTable table-sm" ID="gvDealerHOMember" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Email">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtHOEmail" runat="server" CssClass="form-control form-control-sm" onchange="return validateEmail(this)" MaxLength="40" Text='<%# Eval("email") %>' Width="140"></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemStyle Width="140px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Status*">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblHOContactStatus" runat="server" Text='<%# Eval("contactStatus") %>'></asp:Label>
                                                        </ItemTemplate>
                                                        <EditItemTemplate>
                                                            <asp:DropDownList ID="ddlHOMemberContactStatus" runat="server" CssClass="form-control form-control-sm">
                                                                <asp:ListItem>Select</asp:ListItem>
                                                                <asp:ListItem Value="1">Active</asp:ListItem>
                                                                <asp:ListItem Value="2">Quit</asp:ListItem>
                                                                <asp:ListItem Value="3">Retired</asp:ListItem>
                                                            ...
                                                            <asp:Label ID="lblHOContactStatus" runat="server" Text='<%# Eval("MemberStatus") %>' Visible="false"></asp:Label>
                                                        </EditItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemStyle Width="140px" />
                                                    </asp:TemplateField>
                                        ...
                                        <div>
                                            <table class="table mainGridTable table-sm" border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox CssClass="form-control form-control-sm" ID="txtHeadOfficeEmail" runat="server" onchange="return validateEmail(this)" MaxLength="40" autocomplete="off" />
                                                    </td>
                                                    <td class="chosenFullWidth">
                                                        <asp:DropDownList ID="ddlHOContactStatus" runat="server" CssClass="form-control form-control-sm">
                                                            <asp:ListItem>Select</asp:ListItem>
                                                            <asp:ListItem Value="1" Selected="True">Active</asp:ListItem>
                                                            <asp:ListItem Value="2">Quit</asp:ListItem>
                                                            <asp:ListItem Value="3">Retired</asp:ListItem>
            ...
            <asp:HiddenField ID="HfTimestamp_HeadOffice" runat="server" Value="-1" />
    ...
    <script type="text/javascript">
        ...
        function BindDrp() {
            ...
            //ddlContactStatus
            $('#<%=ddlContactStatus.ClientID%>').chosen();
            $('#<%=ddlHOContactStatus.ClientID%>').chosen();
            $('#<%=ddlTierClassification.ClientID%>').chosen();
            $('#<%=ddlTierClassificationHeader.ClientID%>').chosen();
        }
    </script>
</asp:Content>
