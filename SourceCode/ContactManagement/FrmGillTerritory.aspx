        ...
        <ContentTemplate>
                    ...
                    <div class="col-sm-7 col-md-8 col-lg-6 col-xl-6">
                        <div class="row">
                            <div class="col-sm-auto col-md-auto mb-3">
                                <label class="mb-0">Territory</label>
                            </div>
            ...
            <div class="col-12">
                <div class="row pt-3">
                    ...
                    <div class="col-12">
                        <h5 class="text-uppercase">Gill&#39;s Territory Information</h5>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            <label>Email</label>
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmail" onchange="return validateEmail(this)" runat="server"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
