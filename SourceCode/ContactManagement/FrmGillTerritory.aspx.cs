    ...
    protected void ddlRegion_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (ddlTerr.SelectedIndex > 0)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    HfTimestamp.Value = Convert.ToString(ds.Tables[0].Rows[0]["Timestamp"]);
                    ...
                    if(ddlState.Items.FindByValue(ds.Tables[0].Rows[0]["State"].ToString()) != null)
                    {
                        ddlState.SelectedValue = Convert.ToString(ds.Tables[0].Rows[0]["State"]);
                    }                    
                    if(ddlCountry.Items.FindByValue(ds.Tables[0].Rows[0]["Country"].ToString()) != null)
                    {
        ...
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                if (ddlTerr.SelectedIndex > 0)
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmGillTerritory.aspx", "Update", ddlTerr.SelectedValue);
                    Bind_Controls();
                    Reset();
                }
                else
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmGillTerritory.aspx", "Save", msg);
                    Bind_Controls();
                    Reset();
                }
            }
