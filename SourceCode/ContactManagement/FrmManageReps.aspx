                                ...
                                <div class="modal-body ul-model-info">
                                    <div class="table-responsive">
                                        <div class="row w-100">
                                            ...
                                            <div class="col-6 d-flex flex-column">
                                                <label>Email</label>
                                                <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmail" onchange="return validateEmail(this)" runat="server" MaxLength="40" autocomplete="off" />
                                            </div>
                                            <div class="col-6 d-flex flex-column">
                                    ...
                                    <asp:GridView CssClass="table mainGridTable table-sm" ID="gvSalesRep" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Email">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtEmail" MaxLength="50" onchange="return validateEmail(this)" runat="server" autocomplete="off" Text='<%# Eval("Email") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle />
                                                <ItemStyle Width="14%" />
