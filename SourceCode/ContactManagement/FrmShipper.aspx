...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
            ...
            <div class="col-12">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            <label>Country</label>
                            <asp:DropDownList CssClass="form-control form-control-sm" DataTextField="Country" DataValueField="CountryID" ID="ddlCountry" runat="server" AutoPostBack="True" 
                ...
                <div class="row border-top pt-3">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            ...
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtPhone" Enabled="false" autocomplete="off" MaxLength="30" onblur="phoneMask(this)" runat="server"></asp:TextBox>
                        </div>
                    </div>
                     <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            <label>Cell#</label>
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtCellNo" Enabled="false" autocomplete="off" MaxLength="30" onblur="phoneMask(this)" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group">
                            <label>Email</label>
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmail" Enabled="false" autocomplete="off" MaxLength="50" runat="server" onchange="return validateEmail(this)"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="table-responsive">
                    <asp:GridView CssClass="table mainGridTable table-sm no-scroll" ID="gvShipperMember" runat="server" AutoGenerateColumns="False"
                        DataKeyNames="ShipperMemberID,Timestamp"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Cell#">
                                <ItemTemplate>
                                    <asp:Label ID="lblGridCellNo" runat="server" Text='<%# Eval("CellNo") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <asp:HiddenField ID="hfTimestamp_Member" runat="server" Value="-1" />
