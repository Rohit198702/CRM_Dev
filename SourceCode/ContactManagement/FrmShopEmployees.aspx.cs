...
public partial class ContactManagement_FrmShopEmployees : System.Web.UI.Page
{
    ...
    private DataTable EmptyDT()
    {
        ...
        try
        {
            ...
            dtEmpty.Columns.Add(new DataColumn("TimeStampTraining", typeof(long)));
    ...
    private DataTable EmptyDTShopEmployeeTraining()
    {
        ...
        try
        {
            ...
            dt.Columns.Add(new DataColumn("TimeStampTraining", typeof(long)));
    ...
    private void PrepareDT(int Shopemployeetrainingid, string Desc, int Categoryid, string CategoryName, string Trainer, DateTime? date)
    {
        try
        {
            ...
            {
                drCurrentRow["TrainingDate"] = DBNull.Value;
            }
    ...
    private void EmployeeTrainingAdd()
    {
        try
        {
            ...
            {                
                ...
                TextBox txtFooterDate = (gvShopEmployee.FooterRow.FindControl("txtFooterDate") as TextBox);
                if(txtFooterDate.Text != "")
                {
                    Date =Convert.ToDateTime(txtFooterDate.Text);
                }
                if (btnSave.Text == "Save")
                {
    ...
    protected void gvShopEmployee_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        {
            string msg = "";
            int ID = Convert.ToInt32(gvShopEmployee.DataKeys[e.RowIndex].Values[0]);
            string TimeStampTraining= Convert.ToString(gvShopEmployee.DataKeys[e.RowIndex].Values[1]);
            ObjBOL.Operation = 9;
            ...
            if(TimeStampTraining != "")
            {
                ObjBOL.TimeStampTraining = long.Parse(TimeStampTraining);
            }
            msg = ObjBLL.BLLAddShopEmployeeTraining(ObjBOL);
            if(msg.Trim() == "ER01")
            {
