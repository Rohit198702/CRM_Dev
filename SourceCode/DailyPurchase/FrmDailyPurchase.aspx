                ...
                <div class="row border-top">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtReceivedQty" CssClass="form-control form-control-sm text-right" autocomplete="off" MaxLength="5" runat="server" 
                                onkeypress="return onlyNumbers(this, event);"  oninput="validateNumberOnly(this);"></asp:TextBox>
                        </div>
                    </div>
  ...
  <%--                <div class="col-2" style="display:none">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtUnitPrice" CssClass="form-control form-control-sm text-right" autocomplete="off" MaxLength="10" runat="server" 
                                onkeypress="return onlyDotsAndNumbers(this, event);"  oninput="validateNumberOrDecimal(this);"
                            ...
                            <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvDailyPurchaseDetail" runat="server" AutoGenerateColumns="false" DataKeyNames="ID" ForeColor="White"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Remarks" SortExpression="Remarks">
                                     ...
                                     <asp:TemplateField HeaderText="Updated By" SortExpression="CreatedBy">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCreatedBy" runat="server" Text='<%# Eval("CreatedBy") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Last Modified By" SortExpression="ModifiedBy">
                                        <ItemTemplate>
