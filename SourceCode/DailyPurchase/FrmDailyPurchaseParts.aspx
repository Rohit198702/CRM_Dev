                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlDepartment" CssClass="form-control form-control-sm" runat="server" DataTextField="text" DataValueField="id">
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtMinOrderQty" CssClass="form-control form-control-sm text-right" autocomplete="off" MaxLength="5" runat="server" onkeypress="return onlyNumbers(this, event);"></asp:TextBox>
                        </div>
                    </div>
