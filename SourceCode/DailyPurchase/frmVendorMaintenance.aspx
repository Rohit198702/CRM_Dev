                ...
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtEmail" CssClass="form-control form-control-sm" MaxLength="50" onchange="return validateEmail(this)" runat="server" autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
