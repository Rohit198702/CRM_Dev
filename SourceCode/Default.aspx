...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <ContentTemplate>
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm col-md-12">
                        ...
                        <asp:Button ID="btnTrackJobs" class="btn btn-success btn-sm" runat="server" Visible="false" Text="Track Jobs Status" CausesValidation="false" OnClick="btnTrackJobs_Click" />
                        <asp:Button ID="btnGenerateInvoice" class="btn btn-primary btn-sm" runat="server" Visible="false" Text="Generate Invoice - Smart Conveyer" CausesValidation="false" OnClientClick="window.document.forms[0].target='_blank';" OnClick="btnGenerateInvoice_Click" />
                ...
                <div class="container-fluid p-0 m-0 mt-1">
                    ...
                    <div class="tab-content p-3 border-top-0" id="dashboardTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one-tab">
                            <div class="row border-bottom">
                                ...
                                <div class="col-5">
                                        ...
                                        <div class="table-responsive eoeTable">
                                            <asp:GridView ID="gvProjectedVsActual" CssClass="table mainGridTable table-sm" runat="server" EnableModelValidation="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Cumulative Projected" HeaderStyle-CssClass="align-right">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCumulativeProjected" runat="server" Text='<%# Eval("CumulativeProjected", "{0:C0}") %>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Cumulative Actual" HeaderStyle-CssClass="align-right">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCumulativeActual" runat="server" Text='<%# Eval("CumulativeActual", "{0:C0}") %>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Right" />
                                                    </asp:TemplateField>
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive eoeTable">
                                            <asp:GridView ID="gvSalesCumulativeCurrentMonth" CssClass="table mainGridTable table-sm" runat="server" EnableModelValidation="True"
                                                AutoGenerateColumns="False" ShowFooter="false" OnRowDataBound="gvSalesCumulativeCurrentMonth_RowDataBound">
                                                <Columns>
                                ...
                                <div class="col-7">
                                    <div id="ProjectsVsActualChart" class="h-50 w-100"></div>
                                    <div id="CumulativeProjectedVsActual" class="h-50 w-100"></div>
                                </div>
                            </div>
                        ...
                        <div class="row border-bottom">
                            ...
                            <div class="col-7">
                                <div id="YTDQuotesandOrdersComboChart_div" style="min-height: 300px;" class="w-100 h-100"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style="display: none;">
                <asp:GridView ID="gvSummary" runat="server" CellPadding="3" EmptyDataText="No Items Found" Width="100%" CssClass="verticalHeading mx-auto text-center"
                    EnableModelValidation="True" ShowFooter="true" Visible="false">
                </asp:GridView>
            </div>
    ...
    <script type="text/javascript">
        ...
        const CumulativeProjectedVsSalesObj = [
                {
                    url: "../Default.aspx/GetCumulativeProjectsSalesVsActualSales",
                    headers: ["Month", "Cumulative Projected Sales", "Cumulative  Actual Sales"],
                    containerId: "CumulativeProjectedVsActual",
                    chartType: "ComboChart",
                    rowBuilder: function (item) {
                        return [item.Month, parseFloat(item.ProjectedSales), parseInt(item.ActualSales)];
                    },
                    chartOptions: {
                        options: {
                            ...
                            //title: 'Cumulative YTD Sales: Projected vs Actual Through ' + new Date().toLocaleString('default', { month: 'long' }),
                            title: 'Cumulative YTD Sales: Projected vs Actual Through ' + new Date(new Date().getDate() >= 25 ? new Date() : new Date().setMonth(new Date().getMonth() - 1)).toLocaleString('default', { month: 'long' }),
                            hAxis: {
                                textStyle: { fontSize: 10, bold: true },
                                slantedText: false,
                                slantedTextAngle: 90
        ...
        function cumulativeProjectedVsSales() {
            //console.log("projectedvsSales");
            var config = CumulativeProjectedVsSalesObj[0];
            if (config && config.containerId) {
                var container = document.getElementById(config.containerId);
        ...
        const chartConfigsOrdersandQuotes = [
            {
                ...
                headers: ["Month", "Value of Quotes Sent", "Value of Orders"],
                containerId: "YTDQuotesandOrdersComboChart_div",
                chartType: "ComboChart",
                rowBuilder: function (item) {
                    //return [item.MonthName, parseInt(item.MonthlyQuoteCount), parseFloat(item.TotalQuoteValue), parseInt(item.OrderCount), parseInt(item.TotalBookedValue)];
                    return [item.MonthName, parseFloat(item.TotalQuoteValue), parseInt(item.TotalBookedValue)];
                },
                chartOptions: {
                    options: {
                        chartArea: {
