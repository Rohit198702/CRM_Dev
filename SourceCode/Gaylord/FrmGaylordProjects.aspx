...
<asp:Content ID="cntForm" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="udpForm" runat="server">
        <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm chosenFullWidth">
                                        <asp:DropDownList CssClass="form-control form-control-sm me-2" ID="ddlProjectName" runat="server" DataTextField="text" DataValueField="id" AutoPostBack="true"
                            ...
                            <div class="col-sm-2">
                                <div class="row">
                                    ...
                                    <div class="col-sm chosenFullWidth">
                                        <asp:DropDownList CssClass="form-control form-control-sm me-2" ID="ddlPONumber" runat="server" DataTextField="text" DataValueField="id" AutoPostBack="true"
                                        ...
                                        <asp:Panel ID="PanelJNum" runat="server" DefaultButton="SearchJNumberButton">
                                            ...
                                            <asp:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" TargetControlID="txtSearchPNum"
                                                CompletionInterval="3" CompletionSetCount="10" MinimumPrefixLength="1" CompletionListElementID="PanelJNum_Hidden"
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <asp:Button ID="btnNew" runat="server" CssClass="btn btn-primary btn-sm" OnClick="btnNew_Click" Text="New Order" />
                                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success btn-sm " Text="Save" OnClick="btnSave_Click" />
                                        <asp:Button ID="btnPreviewReport" runat="server" CssClass="btn btn-secondary btn-sm" CausesValidation="false" OnClick="btnPreviewReport_Click" OnClientClick="window.document.forms[0].target='_blank';" Text="Preview Report" />
                                        ...
                                        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-danger btn-sm mt-1 mb-1" Text="Cancel" OnClick="btnCancel_Click" OnClientClick="RemoveQueryString()" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-2 d-flex align-items-center">
                        <div class="form-group mb-0">
                            <div class="input-group input-group-sm d-flex align-items-center">
                                <div class="input-group-prepend pr-3">Release to Nesting</div>
                                <asp:CheckBox ID="chkReleaseToNesting" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <asp:HiddenField ID="HfTimestamp_Shipments" runat="server" Value="-1" />
            <asp:HiddenField ID="HfTimestamp_Parts" runat="server" Value="-1" />
