<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeFile="FrmGaylordProjectsReport.aspx.cs" Inherits="Gaylord_FrmGaylordProjectsReport" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="cntForm" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="glReportForm" runat="server">
        <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">Gaylord Projects Report</h4>
                        </div>
                    </div>
                </div>
