    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
            ...
            <div class="col-12 border-top">
                <div class="row pt-3">
                    <div class="col-12">
                        <h5 class="text-uppercase">Add/Update ETA &emsp;<asp:Button CssClass="btn btn-success btn-sm rounded" ID="btnAdd" runat="server" Text="Add" OnClick="btnAdd_Click" /> 
                            <asp:Button CssClass="btn btn-danger btn-sm rounded" ID="btnResetETA" runat="server" Text="Cancel" OnClick="btnResetETA_Click" />
                        </h5>
                    </div>
            ...
            <div class="col-12">
                <div class="table-responsive">
                    <asp:GridView CssClass="table mainGridTable table-sm no-scroll" ID="GvShipmentTracker" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,TimeStamp"
            ...
            <asp:HiddenField ID="HfBindDaysCountOnETA" runat="server" Value="-1" />
            <asp:HiddenField ID="HfBindDaysCountOnRecDate" runat="server" Value="-1" />
            <asp:HiddenField ID="HfShipBy" runat="server" Value="-1" />
            <asp:HiddenField ID="HfSentDate" runat="server" Value="-1" />
            <asp:HiddenField ID="HfTimeStamp" runat="server" Value="-1" />
            <asp:HiddenField ID="HfTimeStampETA" runat="server" Value="-1" />
