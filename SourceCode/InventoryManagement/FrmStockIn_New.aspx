...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
            <div class="col-12 pt-2 pb-3 piDiv position-sticky">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-2">
                        <label>Dest. Warehouse</label>
                        <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlDestWarehouse" runat="server" DataTextField="Source" DataValueField="id" AutoPostBack="True" OnSelectedIndexChanged="ddlDestWarehouse_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-auto d-flex align-items-end">
                        <asp:Button ID="btnSendEmail" Visible="false" runat="server" CssClass="btn btn-success btn-sm mr-2" Text="Send Email" OnClick="btnSendEmail_Click" />
                        <asp:Button ID="btnPackingDetails" runat="server" CausesValidation="false" Enabled="false" CssClass="btn btn-secondary btn-sm mr-2" OnClientClick="window.document.forms[0].target='_blank';" Text="Generate Packing List" OnClick="btnPackingDetails_Click" />
                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success btn-sm mr-2" Text="Stock In" OnClick="btnSave_Click" OnClientClick="return confirm('Are you sure.?');" Enabled="false" />
                        <asp:Button ID="btnExportNegativeStock" runat="server" CssClass="btn btn-primary btn-sm mr-2" Text="Export Negative Stock In Hand" OnClick="btnExportNegativeStock_Click" Enabled="false" CausesValidation="false" />
                        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-danger btn-sm mr-2" Text="Cancel" OnClick="btnCancel_Click" TabIndex="0" />
                        <asp:Button ID="btnRedirectToStockAdj" runat="server" CssClass="btn btn-primary btn-sm mr-2" Text="Stock Adjustment" Visible="false" OnClick="btnRedirectToStockAdj_Click" TabIndex="0" />
