                    ...
                    <div class="col-sm-7 col-md-8 col-lg-8 col-xl">
                        <div class="row">
                            <div class="col-3">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="mb-0">Product Code</label></div>
                            ...
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="mb-0">Part# (APN/CPN)/Description</label></div>
                                    <div class="col-sm chosenFullWidth">
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox CssClass="form-control form-control-sm" autocomplete="off" Enabled="false" ID="txtProductCode" runat="server"></asp:TextBox>
                        </div>
                    </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Inspection Date">
                                            <EditItemTemplate>
                                                ...
                                                <asp:CalendarExtender ID="CalgvEdittxtInspectionDate" runat="server" TargetControlID="gvEdittxtInspectionDate" Format="MM/dd/yyyy" PopupButtonID="gvEdittxtInspectionDate"></asp:CalendarExtender>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Modify">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton CssClass="btn btn-danger btn-sm" ID="lnkDelete" runat="server" CommandName="Delete" OnClientClick="return confirm('Are you sure to delete.?');"><i class="fas fa-times" title="Delete"></i></asp:LinkButton>
                                            </ItemTemplate>
