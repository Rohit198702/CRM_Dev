                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm chosenFullWidth">
                                        <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success btn-sm control-access-enabled mb-1" Text="Save" OnClientClick="return confirm('Are you sure.?');" OnClick="btnSave_Click" />
                                        <asp:Button ID="btnReport" runat="server" CssClass="btn btn-primary btn-sm control-access-enabled mb-1" Text="Preview Report" OnClick="btnReport_Click" />
                                        <asp:Button ID="btnITWReport" runat="server" CssClass="btn btn-secondary btn-sm control-access-enabled mb-1" Text="ITW Report" OnClick="btnITWReport_Click" />
                                        <asp:Button ID="btnDashboardRedirect" runat="server" CssClass="btn btn-secondary btn-sm mb-1" Enabled="true" OnClick="btnDashboardRedirect_Click" Text="Dashboard" />
                                        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-danger btn-sm control-access-enabled mb-1" Text="Cancel" OnClick="btnCancel_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPartType" runat="server" DataTextField="text" DataValueField="id" CssClass="form-control form-control-sm control-access">
                                </asp:DropDownList>
                            </div>
                        </div>
