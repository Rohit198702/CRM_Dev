    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>            
            <div class="col-12 pt-2 piDiv position-sticky">
                ...
                <div class="row">
                    <div class="col-sm-5 col-md-6 col-lg-5 col-xl-5 ">
                        <div class="row">
                            <div class="col-sm-3 col-md-auto mb-3 chosenFullWidth">
                                <label class="mb-0">Lookup Shipment</label>
                            </div>
                            <div class="col-sm-3 col-md mb-3 col-lg-3">
                            ...
                            <div class="col-sm-4 col-md mb-2 col-lg-4">
                    ...
                    <div class="col-sm col-md col-lg col-xl-auto mb-2">
                        <div class="row">
                            <div class="col-auto">
                                <asp:Button ID="btnSave" runat="server" CssClass="btn btn-success btn-sm" Text="Save" CausesValidation="false" OnClientClick="return confirm('Are you sure.?');this.form.target='_self';" OnClick="btnSave_Click" />
                                <asp:Button ID="btnPackingDetails" runat="server" CausesValidation="false" Enabled="false" CssClass="btn btn-secondary btn-sm" OnClientClick="window.document.forms[0].target='_blank';setTimeout(function(){document.forms[0].target='';},0);"
                                ...
                                <asp:Button ID="btnGenerate" runat="server" CausesValidation="false" Enabled="false" CssClass="btn btn-primary btn-sm" OnClientClick="this.form.target='_blank';" Text="Preview" Visible="false" OnClick="btnGenerate_Click" />
                                ...
                                <asp:Button ID="btnPackingDetailsExcel" runat="server" CausesValidation="false" Enabled="false" CssClass="btn btn-secondary btn-sm" OnClientClick="window.document.forms[0].target='_blank';setTimeout(function(){document.forms[0].target='';},0);"
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control" ID="ddlDestWareHouse" runat="server" DataTextField="Name" DataValueField="WareHouseID"   AutoPostBack="False" 
                            OnSelectedIndexChanged="ddlDestWareHouse_SelectedIndexChanged" onchange="ShowAlert(this)"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label class="text-danger">Invoice No*</label>
                            <asp:TextBox ID="txtInvoiceNo" CssClass="form-control form-control-sm" runat="server" autocomplete="off" MaxLength="50"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label>Container No</label>
                            <asp:TextBox ID="txtContainerNo" CssClass="form-control form-control-sm" runat="server" autocomplete="off" MaxLength="50"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label class="text-danger">Sent Date (Load Date)*</label>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="table-responsive" style="overflow-x: inherit !important; display: none">
                            <table class="table mainGridTable table-sm" border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
                                ...
                                <tr>
                                    <td>
                                        <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlPartNo" runat="server" DataTextField="PartNumber" DataValueField="PartId">
                                        </asp:DropDownList>
                            ...
                            <div class="row pt-3">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvMainRequisitionDetail" CssClass="table mainGridTable table-sm mb-0" DataKeyNames="PartId" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" OnRowDataBound="gvMainRequisitionDetail_RowDataBound">
                                            <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Ship Qty" HeaderStyle-Width="6%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtShippingQty" runat="server" autocomplete="off" CssClass="form-control form-control-sm text-right"
                                                                                Text='<%# Eval("ShipQty") %>'
                                                                                onkeypress="return onlyNumbers(event);" MaxLength="5" onpaste="return false" onchange="CalculateShipQty(event)"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                                ...
                                <ItemStyle HorizontalAlign="Right" />
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Skid No" HeaderStyle-Width="20%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtSkidNo" runat="server" Text='<%# Eval("SkidNo") %>' onkeypress="return limitMultiLineInputLength(this,50);" autocomplete="off" TextMode="MultiLine" CssClass="form-control form-control-sm text-left"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Left" />
                                                                        <ItemStyle HorizontalAlign="Left" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Remarks" HeaderStyle-Width="30%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtItemRemarks" runat="server" Text='<%# Eval("Remarks") %>' onkeypress="return limitMultiLineInputLength(this,500);" autocomplete="off" CssClass="form-control form-control-sm text-left" TextMode="MultiLine"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                        <HeaderStyle HorizontalAlign="Right" />
                                                                        <ItemStyle HorizontalAlign="Right" />
                                                                    </asp:TemplateField>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtJobRemarks" runat="server" onkeypress="return limitMultiLineInputLength(this,500);" CssClass="form-control form-control-sm" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
            ...
            <script type="text/javascript">
                ...
                function ShowAlert(ddlval) {
                    var oldValue = null;
                    var containerid = document.getElementById('<%=ddlContainerNo.ClientID%>');
                    var oldValue = document.getElementById('<%=hfOldDestWareHouseID.ClientID%>').value;                   
                    if (containerid.selectedIndex > 0) {                        
                        if (ddlval.selectedIndex > 0) {
                            console.log('Yes');
                            if (confirm('Do you want to change the Destination. If Yes then all previous POs temporarely removed. Are you sure?')) {                               
                                oldValue = document.getElementById('<%=hfOldDestWareHouseID.ClientID%>').value;  
                                __doPostBack(ddlval.id, '');
                                return true;
                            } else {
                                console.log('No');
                                $('#<%=ddlDestWareHouse.ClientID%>').val(oldValue).trigger('chosen:updated');
                                //ddl.dispatchEvent(new Event('change')); // notify listeners     
                                __doPostBack(ddlval.id, '');
                                return false;
                            }
                        }
                ...
                function CalculateShipQty(event) {
                    var sender = event.target;
                    var row = sender.closest("tr");
                    

                    var lblOrderQty = row.querySelector("span[id$='lblOrderQty']");
                    var txtShipQty = row.querySelector("input[id$='txtShippingQty']");


                    let OrderQty = parseInt(lblOrderQty.innerText, 10);
                    let ShipQty = parseInt(txtShipQty.value, 10);                  
                    // Compare quantities
                    if (ShipQty > OrderQty) {
                        showError("Ship qty not more than order qty !!");
                        txtShipQty.focus();
                    }
                }
            </script>
            ...
            <asp:HiddenField ID="hfOldDestWareHouseID" runat="server" Value="-1" />
