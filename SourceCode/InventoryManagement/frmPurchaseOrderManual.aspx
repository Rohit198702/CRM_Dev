        ...
        <ContentTemplate>
                ...
                <div class="row pt-3">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlShippingMethod" runat="server">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label>Remarks</label>
                            <asp:TextBox ID="txtPORemarks" CssClass="form-control form-control-sm" runat="server" MaxLength="200" autocomplete="off">
                            </asp:TextBox>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row pt-3">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvMainPartDetail" CssClass="table mainGridTable table-sm mb-0" DataKeyNames="PartId" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" OnRowDataBound="gvMainPartDetail_RowDataBound">
                                        <Columns>
                                                    ...
                                                    <asp:Panel ID="pnlPartsDetail" runat="server">
                                                        <asp:GridView CssClass="ChildGrid" ID="gvRequisitionInfo" runat="server" AutoGenerateColumns="False" EnableModelValidation="True" OnRowDataBound="gvRequisitionInfo_RowDataBound" OnRowCommand="gvRequisitionInfo_RowCommand">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Req. Dlv. Date" HeaderStyle-Width="8%">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblGvReqDlrDate" runat="server"
                                                                            Text='<%# Eval("ReqDeliDate") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="MUQ" HeaderStyle-Width="5%">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblMUQ" runat="server" Text='<%# Eval("MUQ") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Right" />
                                                                    <ItemStyle HorizontalAlign="Right" />
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Order Qty" HeaderStyle-Width="5%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtPOOrderQty" runat="server" autocomplete="off" CssClass="form-control form-control-sm text-right"
                                                                            ...
                                                                            onkeypress="return onlyNumbers(event);" MaxLength="5" onpaste="return false" onchange="CheckOrderQty(event)"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Right" />
                                                                    <ItemStyle HorizontalAlign="Right" />
                                                                </asp:TemplateField>
            ...
            <script type="text/javascript">
                ...
                function BindDrp() {
                    ...
                    $('#<%=ddlShippingMethod.ClientID%>').chosen();
                }

                function CheckOrderQty(event) {
                    var sender = event.target;
                    var row = sender.closest("tr");

                    // Get controls inside the row
                    var lblReqQty = row.querySelector("span[id$='lblReqQty']");
                    var txtOrderQty = row.querySelector("input[id$='txtPOOrderQty']");
                    var txtRemarks = row.querySelector("textarea[id$='txtItemRemarks']");

                    // Convert values to numbers
                    let ReqQty = parseInt(lblReqQty.innerText, 10);
                    let OrderQty = parseInt(txtOrderQty.value, 10);
