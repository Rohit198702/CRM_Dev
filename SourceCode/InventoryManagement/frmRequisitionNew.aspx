        ...
        <ContentTemplate>      
            ...
            <div class="col-12">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-1" style="display: none;">
                        <div class="form-group">
            ...
            <div class="col-12 border-top pt-3">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-7 col-md-8 col-lg-5 col-xl-7">
                        <div class="row">
                            <div class="col-sm-3 col-md-auto mb-3">
            ...
            <div class="col-12">
                <div class="row pt-3">
                    <div class="col-sm-8 col-md-4 col-lg-3" style="display: none">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2 col-md-3 col-lg-1">
                        <div class="form-group">
                            <label id="lblminqty" runat="server" data-bs-toggle="tooltip" data-bs-placement="top" title="Minimum Quantity">Min</label>
                            <asp:TextBox ID="txtMinQty" CssClass="form-control form-control-sm text-right" runat="server" Enabled="false"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-2 col-md-3 col-lg-1">
                        <div class="form-group">
                            <label id="lblmaxqty" runat="server" data-bs-toggle="tooltip" data-bs-placement="top" title="Maximum Quantity">Max</label>
                            <asp:TextBox ID="txtMaxQty" CssClass="form-control form-control-sm text-right" runat="server" Enabled="false"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-2 col-md-3 col-lg-1">
                        <div class="form-group">
                            <label>ReOrderQty</label>
                            <asp:TextBox ID="txtReOrderQty" CssClass="form-control form-control-sm text-right" runat="server" Enabled="false"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-3 col-lg-2" id="Department" runat="server" visible="false">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-1" id="DivInStock" runat="server" visible="false">
                        <div class="form-group">
                            <label>StockInHand</label>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-1" id="InTransit" runat="server" visible="false">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-1" id="DivInShop" runat="server" visible="false">
                        <div class="form-group">
                            <label>In Shop</label>
                ...
                <div class="row pt-3">
                    <div class="col-sm-6 col-md-3 col-lg-1">
                        <div class="form-group">
                            <label class="text-danger">Order Type*</label>
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlOrderType" runat="server" DataTextField="OrderType" DataValueField="OrderTypeId" onchange="ShowInputTextBox(this);"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-1" id="divOptions" runat="server" style="display: none">
                        <div class="form-group">
                            <label>Option&emsp;&emsp;&emsp;</label>
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtOptions" runat="server" MaxLength="20" onkeyup="formatInput(this)" onchange="generateText()" autocomplete="off"></asp:TextBox>
                            <asp:Label CssClass="form-control form-control-sm" ID="lblResult" runat="server" Visible="false"></asp:Label>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label class="text-danger">Requested By*</label>
                    ...
                    <div class="col-sm-4 col-md-3 col-lg-1">
                        <div class="form-group">
                            <label class="text-danger">Ship By*</label>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-1">
                        <div class="form-group">
                            <label id="ReqDlvDate" runat="server" data-bs-toggle="tooltip" data-bs-placement="top" title="Requested Delivery Date"> Req.Dlv.Date </label>
                            <asp:TextBox ID="txtTentativeshipdate" CssClass="form-control form-control-sm" autocomplete="off" runat="server" OnBlur="validateDate(this)"></asp:TextBox>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-1">
                        <div class="form-group">
                            ...
                            <asp:TextBox CssClass="form-control form-control-sm text-right" ID="txtfooterqty" MaxLength="5"
                                onkeypress="return onlyNumbers(event);" runat="server" autocomplete="off" onchange="CheckCondition()"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-2 col-md-2 col-lg-1">
                        <div class="form-group">
                            <label id="lblMUQ" runat="server" data-bs-toggle="tooltip" data-bs-placement="top" title="Minimum Urgent Quantity">MUQ</label>
                            <asp:TextBox CssClass="form-control form-control-sm text-right" ID="txtMinUrgentQty" MaxLength="5"
                                onkeypress="return onlyNumbers(event);" runat="server" autocomplete="off"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-2 col-md-3 col-lg-1">
                        <div class="form-group">
                            <label style="display:inline-block;margin-right:35px;">Priority</label>
                            <asp:CheckBox ID="chkfooterPriority" runat="server" style="display:inline-block;" />
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <asp:GridView BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ...
                                ID="gvRequition" runat="server" AutoGenerateColumns="False" DataKeyNames="ReqDetailid,TimeStamp" CssClass="table mainGridTable table-sm"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="UM" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="ReOrderQty" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:Label ID="lblgvReOrderQty" runat="server" Text='<%# Eval("Reorderqty") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Department" ItemStyle-HorizontalAlign="Left" Visible="false">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="In Shop" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Req. Dlv. Date">
                                        <ItemTemplate>
                                            <asp:Label ID="gvRequestedArrivalDate" runat="server" Text='<%# Eval("ReqArrivalDate","{0:MM/dd/yyyy}") %>' autocomplete="off"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" />
                                    ...
                                    <asp:TemplateField HeaderText="MUQ" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <asp:Label ID="gvtxtMinUrgentQty" runat="server" Text='<%# Eval("MinUrgentQty") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Right" />

                                    </asp:TemplateField>
                                    <asp:TemplateField FooterStyle-HorizontalAlign="Left" HeaderText="Priority" ItemStyle-CssClass="ws-nowrap">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="ws-nowrap" FooterStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton CssClass="btn btn-info  btn-sm btn-danger" ID="Delete" runat="server" CommandName="Delete"><i class="fas fa-times" title="Delete"></i></asp:LinkButton>
                                        </ItemTemplate>
         ...
         <asp:TemplateField HeaderText="PO No" HeaderStyle-Width="5%">
           ...
           <asp:Label ID="lblInShop" runat="server" Text='<%# Eval("InShop") %>'>
            ...
            <asp:ModalPopupExtender ID="ModalPopupExtenderShowParts" runat="server" TargetControlID="LinkButton3"
                PopupControlID="PanelShowParts" BackgroundCssClass="modalBackground" CancelControlID="btnClose3">
            </asp:ModalPopupExtender>
                        ...
                        <div class="table-responsive" style="position: sticky; width: 100%; height: 100%; overflow-y: auto;">
                            <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvShowParts" runat="server" AutoGenerateColumns="False" DataKeyNames="Partid"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Order Qty" HeaderStyle-Width="8%" ItemStyle-HorizontalAlign="Right">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtQty" runat="server" Text='<%# Eval("PartQty") %>' CssClass="form-control form-control-sm text-right" onkeypress="return onlyNumbers(event);" MaxLength="5">
                                            </asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="8%" />
            ...
            <asp:ModalPopupExtender ID="ModalPopupStockIn" runat="server" TargetControlID="LinkButton4"
                PopupControlID="PanelStockIn" BackgroundCssClass="modalBackground" CancelControlID="btnClose3">
            </asp:ModalPopupExtender>
            <asp:Panel ID="PanelStockIn" runat="server" CssClass="ReportsModalPopup" Style="display: none;" Width="80%" Height="60%">
                <div class="position-relative h-100">
                    <asp:ImageButton CssClass="position-absolute crossCloseBtn" ID="btnClose3" runat="server" ImageUrl="../images/closebtnCircle.png"
                        AlternateText="Close Popup" ToolTip="Close Popup" />
                    <div class="overflow-y: hidden;">
                        <div class="row justify-content-center">
                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
            ...
            <script type="text/javascript">
                ...
                function AlertCheckStatus(event) {
                    ...
                    if (status == "Submitted for review" || status == "Cancelled" || status == "Rejected" || status == "On hold" || status == "Approved") {
                        ...
                        if (status == "Cancelled" || status == "Rejected" || status == "On hold") {
                            var message = "You are going to " + status  + " " + ReqNo + " for Review.        This will send an email with the requisition as an attachment to        the Purchasing Department. Are you sure to send it?";
                        }
                ...
                function ShowInputTextBox(ddlval){
                    var orderTypeID = ddlval.value;
                    if (orderTypeID == 4) {
                        document.getElementById('<%=divOptions.ClientID%>').style.display = "block";
                    }
                    else {
                        document.getElementById('<%=divOptions.ClientID%>').style.display = "none";
                        document.getElementById('<%=txtOptions.ClientID%>').value="";
                        document.getElementById('<%=txtcomments.ClientID%>').value="";
                    }
                }

              
                function formatInput(textbox) {
                    let val = textbox.value;

                    // Remove non-digit and non-slash characters
                    val = val.replace(/[^0-9\/]/g, "");
                            
                    // If more than 4 digits before slash, insert slash
                    if (val.length > 4 && !val.includes("/")) {
                        val = val.slice(0, 4) + "/" + val.slice(4);
                    }

                    // Ensure only one digit after slash
                    let parts = val.split("/");
                    if (parts.length > 1) {
                        parts[1] = parts[1].slice(0, 1); // only 1 digit allowed
                        val = parts[0] + "/" + parts[1];
                    }
                ...
                function CheckCondition(){
                    let reorderqty=document.getElementById('<%=txtReOrderQty.ClientID%>').value;
                    let partqty=document.getElementById('<%=txtfooterqty.ClientID%>').value;           
                    if(reorderqty == ''){
                        reorderqty=0;
                    }
                    if(partqty>reorderqty){
                        showWarning('Order quantity exceeds the re order level allowed in Part Maintenance.');
                    }
                    else{
                        // console.log('no');
                    }
                ...
                function generateText() {
                    // Get the ASP.NET TextBox value
                    let input = document.getElementById("<%= txtOptions.ClientID %>").value.trim();                    
                    // Check if input contains "/"
                    if (input.includes("/")) {
                        let [total, containers] = input.split("/").map(Number);
                        
                        let base = Math.floor(total / containers);
                        let remainder = total % containers;
                        ...
                        let parts = values.map((val, i) => {                            
                            if (i === 0) return `${val} pcs in next container`;
                            if (i === 1) return `${val} pcs in container after that`;
                            if (i === 2) return `${val} pcs in the following container`;
                            return `${val} pcs in the following container`;
                        });
                        var inputText=`Total ${total} pcs: ${parts.join("; ")}.`;                        
                        document.getElementById('<%= txtcomments.ClientID %>').value = inputText;
                    }else{
            ...
            <asp:HiddenField ID="HfCheckAutoBindUser" runat="server" Value="-1" />
            <asp:HiddenField ID="HfTimeStamp" runat="server" Value="-1" />
             <asp:HiddenField ID="HFTimeStampReqDetail" runat="server" Value="-1" />             
