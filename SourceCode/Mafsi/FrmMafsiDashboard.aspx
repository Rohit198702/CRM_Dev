<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeFile="FrmMafsiDashboard.aspx.cs" Inherits="Mafsi_FrmMafsiDashboard" %>
        ...
        <ContentTemplate>
            <div class="col-12 pt-2 piDiv position-sticky">
                ...
                <div class="row">
                    ...
                    <div class="col-2 mb-2">
                        <div class="row chosenFullWidth">
                            <label class="col-12">Stakeholder</label>
                            <div class="col">
                                <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlStakeholder" DataTextField="text" DataValueField="id"
                                    runat="server" OnSelectedIndexChanged="ddlStakeholder_SelectedIndexChanged" AutoPostBack="true">
                    ...
                    <div class="col-12 mb-2">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                ...
                                <asp:Button ID="btnConvertedSales" runat="server" CssClass="btn btn-secondary btn-sm" Text="Converted Sales" OnClick="btnConvertedSales_Click" Visible="false" />
                                <asp:Button ID="btnCurrentLeads" runat="server" CssClass="btn btn-success btn-sm" Text="Current Leads" OnClick="btnCurrentLeads_Click" Visible="false" />
