<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeFile="FrmMafsiDashboardDealer.aspx.cs" Inherits="Mafsi_FrmMafsiDashboardDealer" %>
...
<asp:Content ID="Content_KPIChina" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel_Mafsi" runat="server">
        <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">Dealer Performance Report</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <h4 id="lblSummaryTable" runat="server">Dealer Summary Table</h4>
            </div>
            ...
            <div class="col-12">
                <h4 id="lblDetailedProfiles" runat="server">Detailed Dealer Profiles</h4>
            </div>
