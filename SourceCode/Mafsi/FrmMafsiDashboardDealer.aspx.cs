...
public partial class Mafsi_FrmMafsiDashboardDealer : System.Web.UI.Page
{
    ...
    private void BindControls()
    {
        try
        {
            ...
            cls.Return_DS(ds, "EXEC Get_MafsiDashboardDealer 1");
    ...
    protected void btnSummary_Click()
    {
        try
        {
            ...
            string query = "EXEC Get_MafsiDashboardDealer 3, 2, " + ddlRegion.SelectedValue + ", " + ddlCompanyName.SelectedValue + ", '"
