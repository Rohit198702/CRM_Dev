<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeFile="FrmMafsiRegionReport.aspx.cs" Inherits="Mafsi_FrmMafsiRegionReport" %>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">Mafsi Region Report</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-2 mb-2">
                        <div class="row chosenFullWidth">
                            ...
                            <div class="col">
                                <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlConsultant" DataTextField="text" DataValueField="id" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>                  
                    ...
                    <div class="col-6 mb-2">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <asp:Button ID="btnReport" runat="server" CssClass="btn btn-secondary btn-sm" CausesValidation="false" OnClick="btnReport_Click" OnClientClick="window.document.forms[0].target='_blank';" Text="Consultant Summary" />
