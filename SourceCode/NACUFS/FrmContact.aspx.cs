    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                if (ddlContacts.SelectedIndex > 0)
                {
                    hfCusId.Value = ddlContacts.SelectedValue;
                    Utility.ShowMessage_Success(this, "Record updated successfully!!. ");
                    Utility.MaintainLogsSpecial("FrmContacts.aspx", "Update", ddlContacts.SelectedValue);
                    Bind_Control();
                    Reset();
                }
                else
                {
                    ...
                    Utility.MaintainLogsSpecial("FrmContacts.aspx", "save", msg);
                    Bind_Control();
                    Reset();
                }
            }
