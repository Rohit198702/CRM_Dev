                    ...
                    <div class="overflow-auto h-100">
                        ...
                        <div class="col-12 mt-2">
                            <div class="row">
                                ...
                                <div class="col-ms-2">
                                    <div class="form-group">
                                        <label>PM Price($)</label>
                                        <asp:TextBox CssClass="form-control form-control-sm text-right" ID="txtPMPrice" MaxLength="15" AutoComplete="off" Text="0" runat="server"
                                            onkeyup="javascript:this.value=Comma(this.value);" AutoCompleteType="Disabled" onkeypress="return onlyDotsAndNumbers(this,event);"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox CssClass="form-control form-control-sm" ID="txtAppointmentDate" AutoComplete="off" runat="server" OnBlur="validateDate(this)"></asp:TextBox>
                                        <asp:CalendarExtender ID="txtAppointmentDate_Extender" runat="server" Format="MM/dd/yyyy" PopupButtonID="txtAppointmentDate" TargetControlID="txtAppointmentDate">
                                        </asp:CalendarExtender>
                                    </div>
                                </div>
                                 ...
                                 <div class="col-sm-2">
                                    <div class="form-group chosenFullWidth">
                                        ...
                                        <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlPOReceived" runat="server">                                            
