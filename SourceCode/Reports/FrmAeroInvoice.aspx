        ...
        <ContentTemplate>
            ...
            <div class="row pt-3">
                ...
                <div class="col-12 pt-2" runat="server" id="divProposalDwgs_HelpSection" style="display:none">
                    ...
                    <div class="col-12">
                        <ul>
                            <li>Date is based on <strong>Sent To RCD Date</strong>.</li> 
        ...
        function DDL() {
         ...
         {             
             ...
             {                 
                 ...
                 document.getElementById('<%=lblFromDate.ClientID%>').innerHTML = "Sent&nbsp;To&nbsp;RCD" + " From&nbsp;Date";
                 document.getElementById('<%=lblToDate.ClientID%>').innerHTML = "Sent&nbsp;To&nbsp;RCD" + " To&nbsp;Date";
             }
