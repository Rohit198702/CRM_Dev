...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                    ...
                    <div class="col-10 row" id="divPartNo" runat="server" visible="false">
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                <label>Status</label>
                                <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlPartStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPartStatus_SelectedIndexChanged">
            ...
            <div class="col-12 pt-0">
                <div class="table-responsive">
                    <asp:GridView CssClass="table mainGridTable table-sm" ID="gvShowStockData"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="S.No" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                <ItemTemplate>
            ...
            <div class="col-10 pt-0">
                <div class="table-responsive">
                    <asp:GridView CssClass="table mainGridTable table-sm" ID="gvInventoryReport"
                        runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                        ForeColor="Black" GridLines="Vertical" Width="100%" AllowSorting="true" DataKeyNames="id" AllowPaging="true" PageSize="5"
                        OnPageIndexChanging="gvInventoryReport_PageIndexChanging"
                        ...
                        OnRowCommand="gvInventoryReport_RowCommand" OnDataBound="gvInventoryReport_DataBound" OnRowCreated="gvInventoryReport_RowCreated">
                        ...
                        <PagerTemplate>
                            ...
                            <nav>
                                <div class="col-4 d-flex align-items-center flex-nowrap">
                                    <label for="ddlPageSize" style="margin-right:12px;"><b>Show Records:</b></label>
                            ...
                            <asp:Repeater ID="rptPager" runat="server" OnItemCommand="rptPager_ItemCommand">
                                <ItemTemplate>
                                    <li class='page-item <%# ((int)Eval("PageIndex") == CurrentPageIndex) ? "active" : "" %>'>
                            ...
                            <li class="page-item">
                                <asp:LinkButton ID="lnkLast" runat="server"
                                    ...
                                    CssClass="page-link">Last</asp:LinkButton>
                            </li>
                        </ul>
                    </nav>
                        </PagerTemplate>
        ...
        <asp:HiddenField ID="hfBindPdf" runat="server" Value="-1" />
             <asp:HiddenField ID="hfbtnshowclick" runat="server" Value="-1" />
        </ContentTemplate>
