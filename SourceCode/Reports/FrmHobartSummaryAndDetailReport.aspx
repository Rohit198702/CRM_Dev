                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="row">
                            <div class="col-md-auto">
                                ...
                                <asp:Button ID="btnExport" CssClass="btn btn-secondary btn-sm" runat="server" Text="Export to Excel" CausesValidation="false" OnClientClick="window.document.forms[0].target='_blank';" OnClick="btnExport_Click" />
