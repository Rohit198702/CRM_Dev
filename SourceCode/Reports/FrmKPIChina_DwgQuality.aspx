<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeFile="FrmKPIChina_DwgQuality.aspx.cs" Inherits="Reports_FrmKPIChina_DwgQuality" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content_KPIChina_DwgQuality" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel_KPIChina_DwgQuality" runat="server">
        <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">KPI Agilent Dwg Quality Report</h4>
                        </div>
                    </div>
                </div>
