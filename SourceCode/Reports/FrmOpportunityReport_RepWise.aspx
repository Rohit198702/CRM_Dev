<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeFile="FrmOpportunityReport_RepWise.aspx.cs" Inherits="Reports_FrmOpportunityReport_RepWise" %>
                        ...
                        <div class="row">
                            <div class="col-12 pt-2">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <h4 class="title-hyphen position-relative">Opportunities Repwise Report</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-12 col-sm-4 col-md-3 col-lg-3">
                                <asp:Label ID="lblPM" runat="server">Sales Rep</asp:Label>
                            ...
                            <div class="col-4 mt-4">
                                <asp:Button ID="btnPreview" runat="server" Enabled="true" CssClass="btn btn-info btn-sm mr-2" CausesValidation="false" Text="Preview"
                                    OnClientClick="window.document.forms[0].target='_blank';" OnClick="btnPreview_Click" />
