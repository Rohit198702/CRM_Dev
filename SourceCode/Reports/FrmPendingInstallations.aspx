...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="form-group chosenFullWidth">
                                    ...
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlInstallationAssignedTo" runat="server" DataTextField="text" DataValueField="id">                                     
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-8">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button ID="btnExport" CssClass="btn btn-primary btn-sm" runat="server" Text="Export to Excel" CausesValidation="false" OnClientClick="window.document.forms[0].target='_blank';" OnClick="btnExport_Click" />
    ...
    <script type="text/javascript">
        ...
        function BindDrp() {
            ...
            $('#<%=ddlInstallationAssignedTo.ClientID%>').chosen();
        }
    </script>
</asp:Content>
