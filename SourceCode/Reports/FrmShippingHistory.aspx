            ...
            <div class="col">
                <asp:GridView ID="gvShippingHistory" runat="server" ForeColor="White" CssClass="table mainGridTable table-sm mb-0" EnableModelValidation="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Model" SortExpression="Models">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Shipped Via" SortExpression="ShippedVia">
                            <ItemTemplate>
                                <asp:Label ID="lblShippedVia" runat="server" Text='<%# Eval("ShippedVia") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
