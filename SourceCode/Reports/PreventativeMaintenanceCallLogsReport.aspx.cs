...
public partial class Reports_PreventativeMaintenanceCallLogsReport : System.Web.UI.Page
{
    ...
    private string PrepareQuery()
    {
        ...
        try
        {
            ...
            query += " h.[CallDetails], h.[Notes], CASE WHEN [PMResponse] = 1 THEN 'Interested' WHEN [PMResponse] = 2 THEN 'Declined'  ";
            query += " WHEN [PMResponse] = 3 THEN 'Undecided' END AS [PMResponse] ";
            ...
            if (ddlPMResponse.SelectedIndex > 0)
            {
                query += " AND h.PMResponse = " + ddlPMResponse.SelectedValue;
            }
