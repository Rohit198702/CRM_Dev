...
public partial class Reports_frmAeroNesting : System.Web.UI.Page
{
    ...
    private DataTable ReportData()
    {
        ...
        try
        {
            ...
            Qstr += " CASE WHEN Inv_Warehouse.WarehouseName Is Null THEN 'Canada' ELSE Inv_Warehouse.WarehouseName END AS FacilityName  ";
            Qstr += " FROM Inv_Warehouse RIGHT JOIN tblHobartBranchListing INNER JOIN qryShpDrgsSales RIGHT JOIN qryAeroDesigners  ";
            ...
            Qstr += " ON Inv_Warehouse.ID = qryNewProjects.MfgFacilityID ";
