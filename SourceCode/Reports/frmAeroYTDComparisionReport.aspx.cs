...
public partial class Reports_frmAeroYTDComparisionReport : System.Web.UI.Page
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            Check_Url_Excel(ddlOptions.SelectedValue);
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
    ...
    private void Check_Url_Excel(string id)
    {
        try
        {
            if (id != null)
            {
                ...
                if (id == "1")
                {
                    GenrateReport_Zero_Excel();
                }
                else if (id == "2")
                {
                    GenrateReport_First_Excel();
                }
                else if (id == "3")
                {
                    if (ddlHobartSalesRep.SelectedIndex == 0)
                    {
                        GenrateReport_FourthAll_Excel();
                    }
                    else
                    {
                        GenrateReport_Fourth_Excel();
                    }
                }
                else if (id == "4")
                {
                ...
                {
                    GenrateReport_Sixth2_Excel();
                }
                else if (id == "6")
                {
                    GenrateReport_fifth_Excel();
                }
                else if (id == "7")
                {
                    GenrateReport_Sixth_Excel();
                }
                else if (id == "8")
                {
                    GenrateReport_Seventh_Excel();
                }
                else if (id == "9")
                {
                    GenrateReport_Eighth_Excel();
                }
                else if (id == "10")
                {
                    GenrateReport_NinthTopTwenty_Excel();
                }
                else if (id == "11")
                {
                    GenrateReport_Eleven_Excel();
                }
                else if (id == "12")
                {
                    GenrateReport_Twelve_Excel();
                }
                else if (id == "13")
                {
                    GenrateReport_Thirteen_Excel();
                }
                else if (id == "14")
                {
                    GenrateReport_Fourteen_Excel();
                }
                else if (id == "15")
                {
                    GenrateReport_Fifteen_Excel();
                }
            }
        }
        catch (Exception ex)
    ...
    private void GenrateReport_Zero_Excel()
    {
        try
        {
            string TSM = null;
            DataRow drCurrentRow = null;
            DataTable dt = ReportDataZero_Excel();
            DataTable dt1 = ReportDataZeroPivot();
            DataSetForGet_YTD_SalesbyTSM_Pivot ds = new DataSetForGet_YTD_SalesbyTSM_Pivot();
            for (int i = dt1.Rows.Count - 1; i >= 0; i--)
            {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rptSales.ReportSource = rprt;
                rptSales.DataBind();
                rprt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.Excel, Response, false, ddlSalesbyAllTSM.SelectedItem.Text + " TSM - Sales Activity Report " + ddlSalesbyTSMYear.SelectedValue);
            }
            else
            {
                rprt.Load(Server.MapPath("~/Reports/rptNoDataFound.rpt"));
    ...
    private void GenrateReport_First_Excel()
    {
        try
        {
            string TSM = null;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rptSales.ReportSource = rprt;
                rptSales.DataBind();
                rprt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.Excel, Response, false, "All TSM - Sales Activity Report " + ddlSalesbyTSMYear.SelectedValue);
            }
            else
            {
                rprt.Load(Server.MapPath("~/Reports/rptNoDataFound.rpt"));
    ...
    private void GenrateReport_FourthAll_Excel()
    {
        try
        {
            DataTable dt = ReportDataSalesbyRepHobart();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rptSales.ReportSource = rprt;
                rptSales.DataBind();
                rprt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.Excel, Response, false, "All Hobart Regions - Sales Activity Report " + ddlHobartRegionYear.SelectedValue);
            }
            else
            {
                rprt.Load(Server.MapPath("~/Reports/rptNoDataFound.rpt"));
    ...
    private void GenrateReport_Fourth_Excel()
    {
        try
        {
            DataTable dt = ReportDataSalesbyRepHobart();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rptSales.ReportSource = rprt;
                rptSales.DataBind();
                rprt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.Excel, Response, false, ddlHobartSalesRep.SelectedItem.Text + " Hobart Region - Sales Activity Report " + ddlHobartRegionYear.SelectedValue);
            }
            else
            {
                rprt.Load(Server.MapPath("~/Reports/rptNoDataFound.rpt"));
    ...
    private void GenrateReport_Second_Excel()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rptSales.ReportSource = rprt;
                rptSales.DataBind();
                rprt.ExportToHttpResponse(CrystalDecisions.Shared.ExportFormatType.Excel, Response, false, ddlSalesRep.SelectedItem.Text + " Rep Group - Sales Activity Report " + ddlRepGroupYear.SelectedValue);
            }
            else
            {
                rprt.Load(Server.MapPath("~/Reports/rptNoDataFound.rpt"));
    ...
    private void GenrateReport_Sixth2_Excel()
    {
        try
        {
            DataTable dt = ReportDataSixth2();
    ...
    private void GenrateReport_fifth_Excel()
    {
        try
        {
            DataTable dt = ReportDatafifth();
    ...
    private void GenrateReport_Sixth_Excel()
    {
        try
        {
            DataTable dt = ReportDataSixth();
    ...
    private void GenrateReport_Seventh_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtOpperStart.Text);
    ...
    private void GenrateReport_Eighth_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtTopOpperStart.Text);
    ...
    private void GenrateReport_NinthTopTwenty_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtOpperFrom.Text);
    ...
    private void GenrateReport_Eleven_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtConFrom.Text);
    ...
    private void GenrateReport_Twelve_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtConFrom.Text);
    ...
    private void GenrateReport_Thirteen_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtConFrom.Text);
    ...
    private void GenrateReport_Fourteen_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtDealerStartDate.Text);
    ...
    private void GenrateReport_Fifteen_Excel()
    {
        try
        {
            DateTime dtfrom = Convert.ToDateTime(txtDealerStartDate.Text);
    ...
    private DataTable ReportDataZero_Excel()
    {
        DataTable dt = new DataTable();
        try
        {
