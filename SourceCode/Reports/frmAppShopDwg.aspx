<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmAppShopDwg.aspx.cs" Inherits="Reports_frmAppShopDwg" %>
                    ...
                    <div class="col-8">
                        ...
                        <div class="col-md-auto mx-auto innerMain">
                            <div class="row pt-3 flex-column">
                                <div class="col-12">
                                    <h4 class="title-hyphen position-relative mb-3">Approved DWG Report</h4>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <label id="lblFrom">Dwg App Date From</label>
                                        ...
                                        <div class="col-sm-12 col-md-3">
                                            <div class="form-group">
                                                <label id="lblTo">Dwg App Date To</label>
                                        ...
                                        <div class="col-12 pt-2">
                                            <div class="form-group mb-0 flex-column">
                                                <div>
                                                    ...
                                                    <asp:Button ID="btnExportExcel" runat="server" CssClass="btn btn-info btn-sm" Text="Export to Excel" CausesValidation="false" Visible="false" OnClick="btnExportExcel_Click" />
                    ...
                    <div class="col-4">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-12 pt-2" runat="server" id="divProposal_HelpSection">
                                <div class="d-flex align-items-center mb-2">
                                    <h5>
                                        <strong>Aerowerks Approved DWG Report</strong>
                                    </h5>
                                </div>
                                <div class="col-12">
                                    <ul>
                                        <li>Date is based on <strong>Dwg Approved Date</strong>.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
