...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlDestination" runat="server" DataTextField="Source" DataValueField="SourceId">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                ...
                <div class="row">
                    <div class="col-md justify-content-center">
                        ...
                        <asp:Button ID="btnGeneratePendingQtyExcel" runat="server" CssClass="btn btn-info btn-sm" CausesValidation="false" Text="Export to Excel Pending Qty" OnClick="btnGeneratePendingQtyExcel_Click" OnClientClick="window.document.forms[0].target='_blank';"/>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnGeneratePendingQtyExcel" />
        </Triggers>
    </asp:UpdatePanel>
