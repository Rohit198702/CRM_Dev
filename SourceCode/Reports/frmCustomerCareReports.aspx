...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <asp:ListItem Value="1" >By Ship to Arrive Date </asp:ListItem>--%>
                                        ...
                                        <asp:ListItem Value="7">Indian Projects </asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-12 pt-2" runat="server" id="divIndianProjects_HelpSection" style="display: none">
                                <div class="d-flex align-items-center mb-2">
                                    <h5>
                                        <strong>Indian Projects</strong>
                                    </h5>
                                </div>
                                <div class="col-12">
                                    <ul>
                                         <li>Date is based on <strong>Ship Date</strong>.</li>
                                        <li>Project Status <strong>Active/Confirmed</strong>.</li>
                                        <li>Project Manufacturing <strong>Triflex</strong>.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <script language="javascript" type="text/javascript">
        function showDiv() {
            ...
            if (getSelectValue == "2") {
                ...
                document.getElementById('<%=divIndianProjects_HelpSection.ClientID%>').style.display = "none";
            }
                ...
                document.getElementById('<%=divStockStatus_HelpSection.ClientID%>').style.display = "none";
                document.getElementById('<%=divStockAdj_HelpSection.ClientID%>').style.display = "none";
                document.getElementById('<%=divIndianProjects_HelpSection.ClientID%>').style.display = "block";
            }
            else {
                document.getElementById('<%=divCCTProject_HelpSection.ClientID%>').style.display = "none";
                document.getElementById('<%=divProjectAcc_HelpSection.ClientID%>').style.display = "none";
