                        ...
                        <div class="row">
                            <div class="col-12 col-sm-4 col-md-3 col-lg-10">
                                <div class="form-group">
                                    ...
                                    <asp:ListBox CssClass="form-control form-control-sm" ID="ddlCategory" runat="server" DataTextField="CategoryName" DataValueField="Categoryid" SelectionMode="multiple"></asp:ListBox>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvSummary" BackColor="White" BorderColor="#999999" BorderWidth="1px"
                            ...
                            runat="server" AutoGenerateColumns="false" EnableModelValidation="True" EmptyDataText="No Matching Records Found !!!" OnRowDataBound="gvSummary_RowDataBound">
                            <Columns>
                                <asp:BoundField DataField="Project Name" HeaderText="Project Name" />
                                <asp:BoundField DataField="Ticket No" HeaderText="Ticket No" />
                                <asp:BoundField DataField="Category" HeaderText="Category" />
                                <asp:BoundField DataField="Issue Category" HeaderText="Issue Category" />
                                <asp:BoundField DataField="Open Date" HeaderText="Open Date" />
                                <asp:BoundField DataField="Close Date" HeaderText="Close Date" />
                                <asp:BoundField DataField="FollowUp Date" HeaderText="FollowUp Date" />
                                <asp:BoundField DataField="Sub Assembly" HeaderText="Sub Assembly" />
                                <asp:BoundField DataField="Conveyor Type" HeaderText="Conveyor Type" />
                                <asp:BoundField DataField="Status" HeaderText="Status" />
                                <asp:BoundField DataField="Assigned To" HeaderText="Assigned To" />
                                <asp:BoundField DataField="Service PO" HeaderText="Service PO" />
                                ...
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        ...
                                        <asp:GridView
                                            ID="gvChild"
                                            runat="server"
                                            CssClass="table mainGridTable table-sm mb-0"
                                            BackColor="White"
                                            BorderColor="#999999"
                                            BorderWidth="1px"
                                            CellPadding="3"
                                            ...
                                            >
                                             <Columns>
                                                  <asp:BoundField DataField="Summary Date" HeaderText="Summary Date" />
