...
public partial class Reports_frmForecasting : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (BindHeader)
                {
                    ...
                    additionalHeaderCell.Text = "<span id=\"additionalHeader\">Inventory Usage from " + txtFromDate.Text + " to " + txtToDate.Text + " </span>";
    ...
    private void GenrateReport_SecondExcel()
    {
        try
        {
            ...
            {
                string FileName = "Inventory Usage " + ddlReportType.SelectedItem.Text + " " + DateTime.Now.ToString("MM/dd/yyyy") + ".xls";
    ...
    protected void btnExporttoPdf_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string FileName = "Inventory Usage " + ddlReportType.SelectedItem.Text + " " + DateTime.Now.ToString("MM/dd/yyyy") + ".pdf";
            Response.AddHeader("content-disposition", "attachment;filename=" + FileName);
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (BindHeader)
                {
                    ...
                    TableHeaderCell additionalHeaderCell = new TableHeaderCell();
                    additionalHeaderCell.Text = "<span id=\"additionalHeader\">Inventory Usage Report from " + txtFromDate.Text + " to " + txtToDate.Text + " </span>";
                    additionalHeaderCell.ColumnSpan = dt.Columns.Count;
                    additionalHeaderRow.Cells.Add(additionalHeaderCell);
