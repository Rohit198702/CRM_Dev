...
public partial class Reports_frmForecastingNew : System.Web.UI.Page
{
    ...
    private void GenrateReport_SecondExcel()
    {
        try
        {
            ...
            if (gvSearch.Rows.Count > 0)
            {
                ...
                string FileName = "Inventory Usage from " + txtFromDate.Text + " to " + txtToDate.Text + ".xls";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    ...
                    int count = (int)ViewState["dtColumn"];
                    cell.Text = "Inventory Usage from " + txtFromDate.Text + " to " + txtToDate.Text;
    ...
    protected void btnExporttoPdf_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string FileName = "Inventory Usage " + DateTime.Now.ToString("MM/dd/yyyy") + ".pdf";
            Response.AddHeader("content-disposition", "attachment;filename=" + FileName);
    ...
    protected void btnMonthlyReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (StringWriter sw = new StringWriter())
            {
                ...
                GridViewRow Row = new GridViewRow(0, 0, DataControlRowType.Header, DataControlRowState.Normal);
                TableHeaderCell cell = new TableHeaderCell();
                int count = ViewState["dtColumn"] != null ? (int)ViewState["dtColumn"] : 0;
                cell.Text = "Inventory Usage from " + txtFromDate.Text + " to " + txtToDate.Text;
                cell.ColumnSpan = count;
                cell.Font.Size = 20;
                cell.HorizontalAlign = HorizontalAlign.Left;
                ...
                //cell.ForeColor = Color.White;
                Row.Controls.Add(cell);
                if (gvMonthlyExportToExcel != null && gvMonthlyExportToExcel.HeaderRow != null)
                {
