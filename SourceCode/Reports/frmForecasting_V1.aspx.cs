    ...
    private DataTable ReportData()
    {
        ...
        try
        {
            if (ValidationCheck() == true)
            {
                ...
                Qstr += " WHERE Inv_AWProduct_Projects.qty IS NOT NULL AND tblProjects.ProjectStatus NOT IN(2, 3) AND Inv_Parts.ForecastItem = 1 ";
                ...
                Qstr += " LEFT JOIN tblProjects ON Inv_AWProduct_Projects.JobID = tblProjects.JobID ";
                Qstr += " LEFT JOIN tblCustomers  ON tblCustomers.CustomerID = tblProjects.CustomerID ";
                Qstr += " LEFT JOIN tblStates ON tblStates.StateID = tblCustomers.StateID WHERE Inv_AWProduct_Projects.qty IS NOT NULL AND Inv_Parts.ForecastItem = 1 ";
