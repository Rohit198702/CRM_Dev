                                    ...
                                    <div class="row">
                                        <div class="col-sm-auto">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox CssClass="form-control form-control-sm" ID="txtFromDate" runat="server" OnBlur="validateDate(this)" AutoComplete="false"></asp:TextBox>
                                        ...
                                        <div class="col-sm-auto">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox CssClass="form-control form-control-sm" ID="txtToDate" runat="server" OnBlur="validateDate(this)" AutoComplete="false"></asp:TextBox>
