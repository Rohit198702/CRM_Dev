                    ...
                    <div class="row pt-3">
                        <div class="col-12">
                            <div class="table-responsive">
                                <asp:GridView ID="gvMainPOReport" Style="font-size: small" CssClass="table mainGridTable table-sm" runat="server" AutoGenerateColumns="False" EnableModelValidation="True">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Req. Dlv. Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDlrDate" runat="server" Text='<%# Eval("ReqDlrDate") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="MUQ">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMinQty" runat="server" Text='<%# Eval("MinUrgentQty") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Container Details">
                                            <ItemTemplate>
                                                <asp:GridView CssClass="ChildGrid" ID="gvContainerInfo" Style="font-size: small" Width="87%"  runat="server" AutoGenerateColumns="False" EnableModelValidation="True">
                                                    <Columns>
