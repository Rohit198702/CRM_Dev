<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="frmProjectPartsConsumptionHistory.aspx.cs" Inherits="Reports_frmProjectPartsConsumptionHistory" %>
                                    ...
                                    <div class="row">                        
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label id="lblFrom">Ship Date From</label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label id="lblTo">Ship Date To</label>
