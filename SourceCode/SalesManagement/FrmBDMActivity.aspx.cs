...
public partial class SalesManagement_FrmBDMActivity : System.Web.UI.Page
{
    ...
    string formName = "FrmBDMActivity.aspx";
    ...
    private void GetQueryParameters()
    {
        try
        {
            ...
            {
                var year = Request.QueryString["ActivityID"];

                if (ddlActivityHeaderList.Items.FindByValue(year) != null)
                {
                    ddlActivityHeaderList.SelectedValue = year;
    ...
    private void GetPermission()
    {
        try
        {
            ...
            if (returnStatus.Trim() == "S01")
            {
                ...
                ddlBDMHeaderList.Enabled = true;
            }
            else if (returnStatus.Trim() == "S02")
            {
                if (ddlBDMHeaderList.Items.FindByValue(Utility.GetCurrentUser().ToString()) != null)
                {
                    ddlBDMHeaderList.SelectedValue = Utility.GetCurrentUser().ToString();
                    ddlBDMHeaderList.Enabled = false;
                    ddlBDMHeaderList_SelectedIndexChanged();
    ...
    private void DisableAll()
    {
        try
        {
            ...
            ddlBDMHeaderList.Enabled = false;
            btnNewSpec.Enabled = false;
            btnNewFollowup.Enabled = false;
            btnAddSpec.Enabled = false;
            btnAddFollowup.Enabled = false;
            btnSaveParticipant.Enabled = false;
            ddlActivityHeaderList.Enabled = false;
            DisableInitial();
        }
        catch (Exception ex)
        {
    ...
    private void DisableInitial()
    {
        try
        {
            btnSaveActivity.Enabled = false;
            //btnOpenSpec.Enabled = false;
            //btnopenFollowup.Enabled = false;
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
    ...
    private void EnableForActivity()
    {
        try
        {
            btnSaveActivity.Enabled = true;
            //btnOpenSpec.Enabled = true;
            //btnopenFollowup.Enabled = true;
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
    ...
    private void BindControls()
    {
        try
        {
            ...
            if (ds.Tables[14].Rows.Count > 0)
            {
                ...
                //gvActivity.DataSource = ds.Tables[14];
                //gvActivity.DataBind();
            }
    ...
    private void BindControlActivity()
    {
        try
        {
            ...
            {
                //gvActivity.DataSource = string.Empty;
                //gvActivity.DataBind();
    ...
    private void ddlBDMHeaderList_SelectedIndexChanged()
    {
        try
        {
            resetExceptHeaders();
    ...
    private void LoadActivityWithoutReset()
    {
        try
        {
    ...
    private void ActivityEdit()
    {
        try
        {
            resetExceptHeaders();
            //if (ddlActivityHeaderList.SelectedIndex > 0)
            if (hfActivityID.Value != "-1")
            {
                EnableForActivity();
                ObjBOL.Operation = 4;
                //ObjBOL.Id = Int32.Parse(ddlActivityHeaderList.SelectedValue);
                ObjBOL.Id = Int32.Parse(hfActivityID.Value);
                DataSet ds = ObjBLL.Return_DataSet(ObjBOL);
                if (ds.Tables.Count == 0 || ds.Tables[0].Rows.Count == 0)
                {
                    return;
                ...
                Dictionary<string, Action<DataRow>> assignments = new Dictionary<string, Action<DataRow>>
                {
                    ...
                    { "Duration", d => txtDurations.Text = Convert.ToString(d["Duration"]) },
    ...
    private void btnCancelActivity_Click()
    {
        try
        {
            if (ddlBDMHeaderList != null && ddlBDMHeaderList.Items.Count > 0 && ddlBDMHeaderList.Enabled == true)
            {
                ddlBDMHeaderList.SelectedIndex = 0;
                BindControlActivity();
            }

            if (ddlActivityHeaderList != null && ddlActivityHeaderList.Items.Count > 0)
            {
                ddlActivityHeaderList.SelectedIndex = 0;
            }

            hfActivityID.Value = "-1";
    ...
    private void resetExceptHeaders()
    {
        try
        {
            ...
            if (ddlBDM != null && ddlBDM.Items.Count > 0 && ddlBDM.Enabled == true)
            {
                ddlBDM.SelectedIndex = 0;
            }
    ...
    protected void btnSaveActivity_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ObjBOL.Discussion = txtDiscussion.Text.Trim();
            ObjBOL.BusinessOutcome = txtBusinessOutcome.Text.Trim();
            ...
            {
                ObjBOL.TeamPostedDate = Utility.ConvertDateFormat(txtTeamPostedDate.Text.Trim());
            }
            ...
            if (txtDurations.Text.Trim() != "")
            {
                ObjBOL.Duration = decimal.Parse(txtDurations.Text);
            }
    ...
    protected void btnSaveParticipant_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //ObjBOL.ActivityId = Int32.Parse(ddlActivityHeaderList.SelectedValue);
                ObjBOL.ActivityId = Int32.Parse(hfActivityID.Value);
            }
            ...
            ObjBOL.Details = txtDetails_Participant.Text.Trim();
            ...
            ObjBOL.Remarks = txtRemarks.Text.Trim();
    ...
    protected void gvActivityParticipant_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            if (returnStatus != "")
            {
                Utility.MaintainLogsSpecial(formName, "Delete-Participant", hfActivityID.Value);
    ...
    private bool validationCheck_Followup()
    {
        try
        {
            ...
            {
                Utility.ShowMessage_Error(Page, "Please create Followup No !!");
            ...
            {
                Utility.ShowMessage_Error(Page, "Please enter Due Date !!");
                txtDueDate_Followup.Focus();
                return false;
            }
    ...
    protected void btnAddFollowup_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ObjBOL.FollowupNo = txtFollowupNo_Followup.Text.Trim();
            ...
            ObjBOL.Subject = txtSubject_Followup.Text.Trim();
            ...
            ObjBOL.Discussion = txtDescription_Followup.Text.Trim();
            ...
            ObjBOL.Remarks = txtRemarks_Followup.Text.Trim();
    ...
    protected void gvFollowups_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            if (returnStatus != "")
            {
                Utility.MaintainLogsSpecial(formName, "Delete_Followup", hfActivityID.Value);
    ...
    private bool validationCheck_Spec()
    {
        try
        {
            ...
            if (txtNextAction_Spec.Text == "" && !new[] { "4", "5" }.Contains(ddlProjectStage_Spec.SelectedValue))
            {
                Utility.ShowMessage_Error(Page, "Please enter Next Action !!");
                txtNextAction_Spec.Focus();
                return false;
            }

            if (txtNextActionDate_Spec.Text == "" && !new[] { "4", "5" }.Contains(ddlProjectStage_Spec.SelectedValue))
            {
                Utility.ShowMessage_Error(Page, "Please enter Next Action Date !!");
                txtNextActionDate_Spec.Focus();
                return false;
            }
        }
        catch (Exception ex)
    ...
    protected void btnAddSpec_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ObjBOL.SpecNo = txtSpecNo_Spec.Text.Trim();
            ObjBOL.ProjectName = txtProjectName_Spec.Text.Trim();
            ...
            ObjBOL.City = txtCity_Spec.Text.Trim();
            ObjBOL.Address = txtAddress_Spec.Text.Trim();
            ...
            if (ddlProbability_Spec.SelectedIndex > 0)
            {
                ObjBOL.Probability = Int32.Parse(ddlProbability_Spec.SelectedValue);
            }
            ...
            if (txtNextActionDate_Spec.Text != "")
            {
                ObjBOL.NextActionDate = Utility.ConvertDateFormat(txtNextActionDate_Spec.Text);
            }

            ObjBOL.NextAction = txtNextAction_Spec.Text.Trim();
            ObjBOL.Competitor = txtCompetitor_Spec.Text.Trim();
            ObjBOL.BusinessOpportunity = txtBusinessOpportunity_Spec.Text.Trim();
            ObjBOL.CurrentIssue = txtCurrentIssue_Spec.Text.Trim();
            ...
            ObjBOL.PNumber = txtPNumber_Spec.Text;
    ...
    private void btnCancelSpec_Click()
    {
        try
        {
            ...
            if (ddlProjectStage_Spec.Items.Count > 0)
            {
                ...
                ddlProjectStage_Spec_SelectedIndexChanged();
            }
            ...
            if (ddlProbability_Spec.Items.Count > 0)
            {
                ddlProbability_Spec.SelectedIndex = 0;
            }

            txtNextAction_Spec.Text = string.Empty;
            txtNextActionDate_Spec.Text = string.Empty;
            ...
            txtPNumber_Spec.Text = string.Empty;
    ...
    protected void gvSpecDetails_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            if (returnStatus != "")
            {
                Utility.MaintainLogsSpecial(formName, "Delete_Spec", hfActivityID.Value);
    ...
    protected void gvSpecDetails_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            Dictionary<string, Action<DataRow>> assignments = new Dictionary<string, Action<DataRow>>
            {
                ...
                { "ProbabilityPercent", d =>
                    {
                        if (ddlProbability_Spec.Items.FindByValue(Convert.ToString(d["ProbabilityPercent"])) != null)
                        {
                            ddlProbability_Spec.SelectedValue = Convert.ToString(d["ProbabilityPercent"]);
                        }
                        else if(ddlProbability_Spec.Items.Count > 0)
                        {
                            ddlProbability_Spec.SelectedIndex = 0;
                        }
                    }
                ...
                { "NextAction", d => txtNextAction_Spec.Text = Convert.ToString(d["NextAction"]) },
                { "NextActionDate", d => txtNextActionDate_Spec.Text = Convert.ToString(d["NextActionDate"]) },
                ...
                { "PNumber", d => txtPNumber_Spec.Text = Convert.ToString(d["PNumber"]) },
                { "OwnerUserID", d =>
                    {
    ...
    private void ddlActivityType_SelectedIndexChanged()
    {
        try
        {
            ...
            else if (new[] { "3", "6" }.Contains(ddlActivityType.SelectedValue))
            {
            ...
            else if (ddlActivityType.SelectedValue == "4")
            {
                lblParticipant.InnerText = "Sales Rep";

                dt.AsEnumerable().Where(r => r.Field<int>("id") != 3).ToList().ForEach(r => dt.Rows.Remove(r));
                dt.AcceptChanges();
            ...
            else if (ddlActivityType.SelectedValue == "5")
            {
                lblParticipant.InnerText = "Customer";

                dt.AsEnumerable().Where(r => r.Field<int>("id") != 4).ToList().ForEach(r => dt.Rows.Remove(r));
                dt.AcceptChanges();
    ...
    protected void btnOpenSpec_Click(object sender, EventArgs e)
    {
        try
        {
            Modal_Spec.Show();
            lblActivity_Spec.Text = txtActivityNo.Text;
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
    ...
    protected void btnopenFollowup_Click(object sender, EventArgs e)
    {
        try
        {
            Modal_Followup.Show();
            lblActivity_Followup.Text = txtActivityNo.Text;
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
    ...
    protected void btnOpenParticipant_Click(object sender, EventArgs e)
    {
        try
        {
            Modal_Participant.Show();
    ...
    protected void gvActivity_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            int ID = Convert.ToInt32(gvActivity.DataKeys[e.RowIndex].Values[0]);
            string TimeStamp = Convert.ToString(gvActivity.DataKeys[e.RowIndex].Values[1]);
            ObjBOL.Operation = 29;
            ObjBOL.Id = ID;
            if (TimeStamp != "")
            {
            ...
            if (returnStatus != "")
            {
                Utility.MaintainLogsSpecial(formName, "Delete-Activity", ID.ToString());
    ...
    protected void gvActivity_RowEditing(object sender, GridViewEditEventArgs e)
    {
        try
        {
            ...
            hfActivityID.Value = gvActivity.DataKeys[e.NewEditIndex].Values[0].ToString();
            ActivityEdit();
        }
        catch (Exception ex)
        {
    ...
    protected void gvActivity_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            GridViewRow row = gvActivity.Rows[rowIndex];
            var dataKeyValue = gvActivity.DataKeys[rowIndex].Values[0].ToString();
            hfActivityID.Value = dataKeyValue;
            string activityNo = ((Label)row.FindControl("lblActivityNo")).Text;

            if (e.CommandName == "Followup")
            {
                Modal_Followup.Show();
                lblActivity_Followup.Text = activityNo;
                GetFollowupGrid();
                btnCancelFollowup_Click();
            }

            if (e.CommandName == "Spec")
            {
                Modal_Spec.Show();
                lblActivity_Spec.Text = activityNo;
                GetSpecGrid();
                btnCancelSpec_Click();
            }
            ...
            if (e.CommandName == "Participant")
            {
                ...
                {
                    Modal_Participant.Show();
                    lblActivity_Participant.Text = activityNo;
                    GetParticipantGrid();
                    btnCancelParticipant_Click();
                    ...
                    if (ddlActivityType.Items.FindByValue(Convert.ToString(dr["ActivityTypeID"])) != null)
                    {
                        ddlActivityType.SelectedValue = Convert.ToString(dr["ActivityTypeID"]);
                        ddlActivityType_SelectedIndexChanged();
                    }
    ...
    protected void gvActivity_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            int participantCount = Convert.ToInt32(row["ParticipantCount"]);
            int specCount = Convert.ToInt32(row["SpecCount"]);
            int followupCount = Convert.ToInt32(row["FollowupCount"]);

            LinkButton lnkParticipant = (LinkButton)e.Row.FindControl("lnkOpenParticipant");
            LinkButton lnkSpecs = (LinkButton)e.Row.FindControl("lnkOpenSpecs");
            LinkButton lnkFollowups = (LinkButton)e.Row.FindControl("lnkFollowups");

            lnkParticipant.Text = string.Format("Participants ({0})", participantCount);
            lnkSpecs.Text = string.Format("Specs ({0})", specCount);
            lnkFollowups.Text = string.Format("Follow-ups ({0})", followupCount);
        }
        catch (Exception ex)
        {
            Utility.AddEditException(ex);
    ...
    protected void ddlProjectStage_Spec_SelectedIndexChanged(object sender, EventArgs e)
    {
        Modal_Spec.Show();
        ddlProjectStage_Spec_SelectedIndexChanged();
    }

    private void ddlProjectStage_Spec_SelectedIndexChanged()
    {
        try
        {
            if (new[] { "4", "5" }.Contains(ddlProjectStage_Spec.SelectedValue))
            {
                lblNextAction.InnerText = "Next Action";
                lblNextAction.Attributes["class"] = "";

                lblNextActionDate.InnerText = "Next Action Date";
                lblNextActionDate.Attributes["class"] = "";
            }
            else
            {
                lblNextAction.InnerText = "Next Action*";
                lblNextAction.Attributes["class"] = "text-danger";

                lblNextActionDate.InnerText = "Next Action Date*";
                lblNextActionDate.Attributes["class"] = "text-danger";
            }
        }
        catch (Exception ex)
        {
    ...
    {
        Response.Redirect("~/Reports/FrmBDMActivityReport.aspx", false);
    }
    ...
    protected void gvSpecDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Modal_Spec.Show();
            if (e.CommandName == "Create_PNumber")
            {
                if (!CheckSpecPNumber())
                {
                    return;
                ...
                int rowIndex = Convert.ToInt32(e.CommandArgument);
                int id = Int32.Parse(gvSpecDetails.DataKeys[rowIndex].Values[0].ToString());
                Response.Redirect("~/SalesManagement/FrmProposals.aspx?BDMActivity=" + id.ToString(), false);
            }
        }
        catch (Exception ex)
        {
    ...
    private bool CheckSpecPNumber()
    {
        try
        {
            ...
            {
                Utility.ShowMessage_Error(Page, "P# already created for Activity !");
                return false;
            }
            else
            {
