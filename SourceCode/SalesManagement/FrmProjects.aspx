...
<asp:Content ID="Content_Projects" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel_Projects" runat="server">
        <ContentTemplate>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group chosenFullWidth">
                                    ...
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlBusinessDivision" runat="server">
                                        <asp:ListItem Value="">Select</asp:ListItem>
                                        <asp:ListItem Value="1">Aerowerks Mississauga</asp:ListItem>
                                        <asp:ListItem Value="2">Aerowerks Gaffney</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:ModalPopupExtender ID="ModalPopupExtenderExistingJob" runat="server" TargetControlID="LinkButton2"
                                        PopupControlID="Panel3" BackgroundCssClass="modalBackground" CancelControlID="btnClose">
                                    </asp:ModalPopupExtender>
                                    <asp:Panel ID="Panel3" runat="server" CssClass="ReportsModalPopup" Style="display: none" Width="40%" Height="50%">
                                                        ...
                                                        <asp:GridView CssClass="table mainGridTable table-sm" ID="gvExistingJobID" runat="server" AutoGenerateColumns="False" DataKeyNames="ExistingJobID" OnRowDeleting="gvExistingJobID_RowDeleting"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField ItemStyle-CssClass="ws-nowrap" HeaderStyle-Width="5%">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton CssClass="btn btn-info btn-danger" ID="LinkButton1" OnClientClick="return confirm('Are you sure to delete. ?');" runat="server" CommandName="delete"><i class="fas fa-times" title="Delete"></i></asp:LinkButton>
                                                                    </ItemTemplate>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Existing Proposals</label>
                                    <div class="input-group input-group-sm d-flex align-items-center">
                                        <asp:Label ID="lblExistingProposalDetails" runat="server"></asp:Label>
                                        <asp:Button ID="btnExistingProposal" runat="server" CssClass="btn btn-primary btn-sm" Text="Add" Enabled="false" OnClick="btnExistingProposal_Click" />
                                    </div>
                                    <asp:ModalPopupExtender ID="ExistingProposal_Extender" runat="server" TargetControlID="btnExistingProposal_1"
                                        PopupControlID="ExistingProposal_Panel" BackgroundCssClass="modalBackground" CancelControlID="btnClose_ExistingProposals">
                                    </asp:ModalPopupExtender>
                                    <asp:Panel ID="ExistingProposal_Panel" runat="server" CssClass="ReportsModalPopup" Style="display: none" Width="40%" Height="60%">
                                        <div class="position-relative h-100">
                                            <asp:ImageButton CssClass="position-absolute crossCloseBtn" ID="btnClose_ExistingProposals" runat="server" ImageUrl="../images/closebtnCircle.png"
                                                AlternateText="Close Popup" ToolTip="Close Popup" />
                                            <div class="overflow-auto h-100">
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lblJobNo" runat="server"></asp:Label></h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr />
                                                            ...
                                                            <div class="form-group chosenFullWidth">
                                                                <div class="col-12">
                                                                    <div class="form-group chosenFullWidth">
                                                                        <%--<label>Proposal #</label>--%>
                                                                        <div class="input-group input-group-sm d-flex align-items-center flex-nowrap">
                                                                            <asp:Panel ID="ExistingProposal_Panel_2" runat="server" CssClass="form-control form-control-sm" Style="height: 200px; overflow: scroll; display: none;"></asp:Panel>

                                                                            <div class="col-sm chosenFullWidth pl-0">
                                                                                <asp:Panel ID="ExistingProposal_Panel_3" runat="server" Style="height: 200px; overflow: scroll; display: none;">
                                                                                </asp:Panel>
                                                                                <asp:Panel ID="ExistingProposal_Panel_4" runat="server">
                                                                                    <asp:TextBox ID="txtExistingProposal" AutoComplete="off" placeholder="Type Proposal #" CssClass="form-control form-control-sm"
                                                                                        OnBlur="return ClickEventForPNumber_1(event)" runat="server">
                                                                                    </asp:TextBox>
                                                                                    <asp:AutoCompleteExtender ID="txtExistingProposal_Extender" runat="server" TargetControlID="txtExistingProposal"
                                                                                        CompletionInterval="1" CompletionSetCount="10" MinimumPrefixLength="1" CompletionListElementID="ExistingProposal_Panel_2"
                                                                                        ServicePath="../AutoComplete.asmx" ServiceMethod="SearchPNumberOnly" CompletionListCssClass="autocomplete" />

                                                                                    <asp:Button ID="btnExistingProposals_1" runat="server" Text="Submit" Style="display: none" OnClick="btnExistingProposals_1_Click" />
                                                                                </asp:Panel>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <asp:Button ID="btnAddExistingProposal" runat="server" CssClass="btn btn-primary btn-sm" Text="Add" OnClick="btnAddExistingProposal_Click" />
                                                                <asp:Button ID="btnCancelExistingProposal" runat="server" CssClass="btn btn-danger btn-sm" Text="Cancel" OnClick="btnCancelExistingProposal_Click" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <asp:Label ID="lblErrorExistingProposal" runat="server"></asp:Label>
                                                <hr />
                                                <div class="col-12">
                                                    <h5 class="text-uppercase">Existing Proposal Information</h5>

                                                    <div class="table-responsive">
                                                        <asp:GridView CssClass="table mainGridTable table-sm" ID="gvExistingProposal" runat="server" AutoGenerateColumns="False" DataKeyNames="PNumber" OnRowDeleting="gvExistingProposal_RowDeleting"
                                                            EnableModelValidation="True" Height="100%" Style="margin-top: 0px">
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="P #" HeaderStyle-Width="40%">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField ItemStyle-CssClass="ws-nowrap" HeaderStyle-Width="5%">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton CssClass="btn btn-info btn-danger" ID="lnkDeletePNumber" OnClientClick="return confirm('Are you sure to delete. ?');" runat="server" CommandName="delete"><i class="fas fa-times" title="Delete"></i></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                </asp:TemplateField>
                                                            </Columns>
                                    ...
                                    <asp:LinkButton ID="btnExistingProposal_1" runat="server"></asp:LinkButton>
                                </div>
                            </div>
                        ...
                        <div class="row" id="icsGeneralInformation" runat="server">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group chosenFullWidth">
                                    ...
                                    <asp:DropDownList CssClass="form-control form-control-sm paymentSection" ID="ddlCurrency" runat="server" DataTextField="Currency" DataValueField="CurrencyID"
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtEqPrice" MaxLength="15" AutoComplete="off" runat="server" onkeyup="javascript:this.value=Comma(this.value);" AutoCompleteType="Disabled" onchange="checkDot(this);getCalc();getPer();"
                                        onkeypress="return onlyDotsAndNumbers(this,event);" oninput="sanitizeDecimalInput(this)" AutoPostBack="true" OnTextChanged="txtEqPrice_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Eq Discount%</label>
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtEqDiscount" MaxLength="15" AutoComplete="off" runat="server" oninput="sanitizeDecimalInput(this)" onkeyup="javascript:this.value=Comma(this.value);" AutoCompleteType="Disabled" onchange="getCalc();" onkeypress="return onlyDotsAndNumbers(this,event);" AutoPostBack="true" OnTextChanged="txtEqPrice_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Eq Dis Amount($)</label>
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtEqDisAmount" MaxLength="15" AutoComplete="off" runat="server" oninput="sanitizeDecimalInput(this)" onkeyup="javascript:this.value=Comma(this.value);" AutoCompleteType="Disabled" onchange="getPer()" onkeypress="return onlyDotsAndNumbers(this,event);" AutoPostBack="true" OnTextChanged="txtEqPrice_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Freight($)</label>
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtFreight" MaxLength="15" AutoComplete="off" runat="server" oninput="sanitizeDecimalInput(this)" onkeyup="javascript:this.value=Comma(this.value);" AutoCompleteType="Disabled" onchange="checkDot(this);getCalc();getPer()" onkeypress="return onlyDotsAndNumbers(this,event);" AutoPostBack="true" OnTextChanged="txtFreightAndInstallation_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Installation($)</label>
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtInstall" MaxLength="15" AutoComplete="off" runat="server" oninput="sanitizeDecimalInput(this)" onkeyup="javascript:this.value=Comma(this.value);" AutoCompleteType="Disabled" onchange="checkDot(this);getCalc();getPer()" onkeypress="return onlyDotsAndNumbers(this,event);" AutoPostBack="true" OnTextChanged="txtFreightAndInstallation_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtExWarranty" MaxLength="15" AutoComplete="off" runat="server" oninput="sanitizeDecimalInput(this)" onkeyup="javascript:this.value=Comma(this.value);" AutoCompleteType="Disabled" onchange="checkDot(this);getCalc();getPer()" onkeypress="return onlyDotsAndNumbers(this,event);"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtReasonForPriceUpdate" AutoComplete="off" runat="server" Enabled="false" MaxLength="500" TextMode="MultiLine"
                                        oninput="return limitMultiLineInputLength(this, 500)"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group chosenFullWidth">
                                    <label>Commission Report Override</label>
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlCommRepOverride" runat="server" Enabled="false" onchange="EnabledDisabled()">
                                        <asp:ListItem Value="0">Auto</asp:ListItem>
                                        <asp:ListItem Value="1">Hobart Canada</asp:ListItem>
                                        <asp:ListItem Value="2">Hobart US</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                             <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group srRadiosBtns">
                                    ...
                                    <asp:RadioButtonList ID="rdbSupervision" runat="server" CssClass="paymentSection" RepeatDirection="Horizontal">                                    
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-4">
                                <div class="form-group">
                                    <label class="text-danger">Commission Report Override Reason*</label>
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtCommReportOverrideReason" AutoComplete="off" runat="server" MaxLength="500"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row pt-3" id="icsEarlyPaymentCashDiscount_2" runat="server">
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm text-right" ID="txtAmountInvoiced" onkeypress="return onlyDotsAndNumbers(this,event);" oninput="sanitizeDecimalInput(this)" AutoComplete="off" MaxLength="15" Enabled="false" AutoPostBack="true" runat="server" OnTextChanged="txtAmountInvoiced_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label title="Net Eq Price($) - Discount Percentage (%)">Discount Amount ($)</label>
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtCashDiscountAmount" onkeypress="return onlyDotsAndNumbers(this,event);" oninput="sanitizeDecimalInput(this)" AutoComplete="off" MaxLength="15" onchange="checkDot(this);" AutoPostBack="true" runat="server" OnTextChanged="txtCashDiscountAmount_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm text-right paymentSection" ID="txtCashDiscountPer" onkeypress="return onlyDotsAndNumbers(this,event);" oninput="sanitizeDecimalInput(this)" AutoComplete="off" MaxLength="15" runat="server" onchange="checkDot(this);" AutoPostBack="True" OnTextChanged="txtCashDiscountPer_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                        ...
                        <div class="row border-top pt-2">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtDeliveryDate" AutoComplete="off" runat="server" OnBlur="validateDate(this)"></asp:TextBox>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtEmailDescription" autocomplete="off"
                                        TextMode="MultiLine" oninput="return limitMultiLineInputLength(this, 500)" runat="server"></asp:TextBox>
                                </div>
                            </div>

                            <div class="col-6 col-sm-8 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Upload (PDF/Doc/Excel Max 5 Mb Collective Size)</label>

                                    <div class="d-flex align-items-center gap-2">
                                        <asp:FileUpload ID="fuUploadDoc_CalendarEvent" runat="server"
                                            CssClass="btn btn-success btn-sm" Style="width: 300px" multiple
                                            onchange="CheckFileValidations_CalendarEvent()" />

                                        <asp:Button ID="btnDeleteFiles_Calendar" runat="server"
                                            CssClass="btn btn-danger btn-sm ml-1"
                                            Text="Delete Files" Visible="false"
                                            OnClientClick="return confirm('Are you sure to delete.?');"
                                            OnClick="btnDeleteFiles_Calendar_Click" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group chosenFullWidth">
                                    ...
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlShipperContactName" AutoComplete="off" MaxLength="30" runat="server" AutoPostBack="true" DataValueField="ContactID" Enabled="false"
                                        DataTextField="ContactName" OnSelectedIndexChanged="ddlShipperContactName_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        ...
                        <div class="row border-top pt-3">
                            ...
                            <div class="col-2">
                                <div class="form-group chosenFullWidth">
                                    ...
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlInstallationStatus" runat="server" DataValueField="InstallationStatusID" DataTextField="InstallationStatus">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group chosenFullWidth">
                                    ...
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlInstallationAssTo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlThirdPartyInstallers_SelectedIndexChanged"
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group chosenFullWidth">
                                    <label>Third Party Installers</label>
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlThirdPartyInstallers" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlThirdPartyInstallers_SelectedIndexChanged"
                                        DataTextField="text" DataValueField="id" Enabled="false">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm text-right" ID="txtInstallationAmount" MaxLength="15" AutoComplete="off" runat="server" onkeyup="javascript:this.value=Comma(this.value);"
                                        Enabled="false" onkeypress="return onlyDotsAndNumbers(this,event);"></asp:TextBox>
                                </div>
                            </div>

                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Installation PO#</label>
                                    <asp:TextBox CssClass="form-control form-control-sm " ID="txtPO_Installation" MaxLength="50" AutoComplete="off" runat="server"
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Installation Invoice#</label>
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtInvoice_Installation" MaxLength="50" AutoComplete="off" runat="server"
                                        Enabled="false"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Tentative End Days(1-100)</label>
                                    <asp:TextBox CssClass="form-control form-control-sm text-right" ID="txtTentativeEndDays" MaxLength="3" AutoComplete="off" runat="server" onkeyup="javascript:this.value=Comma(this.value);clamp100(this);"
                            ...
                            <div class="col-3 col-sm-2 col-md-2 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm d-flex align-items-center">
                                        <asp:TextBox CssClass="form-control form-control-sm" ID="txtInstallationEnd" AutoComplete="off" runat="server" OnBlur="validateDate(this)"
                                            AutoPostBack="true" OnTextChanged="txtInstallationEnd_TextChanged"></asp:TextBox>
                            ...
                            <div class="col-8 col-sm-6 col-md-5 col-lg-4">
                                <div class="form-group srRadiosBtns">
                                    ...
                                    <asp:RadioButtonList ID="rdbCommissioning" runat="server" RepeatDirection="Horizontal">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Commissioning Comments</label>
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtCommissioningComments" AutoComplete="off" runat="server" MaxLength="250"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                                <div class="form-group">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label></label>
                                    <asp:Button ID="btnProspecting" runat="server" CssClass="btn btn-primary btn-sm mb-3" CausesValidation="false" Text="Prospecting" OnClick="btnProspecting_Click" />
                                </div>
                            </div>
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                        ...
                        <div class="row pt-2">
                            ...
                            <div class="col-3 col-sm-3">
                                <div class="form-group srRadiosBtns">
                                    ...
                                    <asp:RadioButtonList ID="rdbPlumbing" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="" Selected="True">None</asp:ListItem>
                                        <asp:ListItem Value="0">Not Done</asp:ListItem>
                                        <asp:ListItem Value="1">Done</asp:ListItem>
                                    </asp:RadioButtonList>
                            ...
                            <div class="col-3 col-sm-3">
                                <div class="form-group srRadiosBtns">
                                    ...
                                    <asp:RadioButtonList ID="rdbElectrical" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="" Selected="True">None</asp:ListItem>
                                        <asp:ListItem Value="0">Not Done</asp:ListItem>
                                        <asp:ListItem Value="1">Done</asp:ListItem>
                                    </asp:RadioButtonList>
                            ...
                            <div class="col-3 col-sm-3">
                                <div class="form-group srRadiosBtns">
                                    <label>Testing</label>
                                    <asp:RadioButtonList ID="rdbTesting" runat="server" RepeatDirection="Horizontal">
                                        <asp:ListItem Value="" Selected="True">None</asp:ListItem>
                                        <asp:ListItem Value="0">Not Done</asp:ListItem>
                                        <asp:ListItem Value="1">Done</asp:ListItem>
                                    </asp:RadioButtonList>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtTestRemarks" AutoComplete="off" runat="server" MaxLength="250"></asp:TextBox>
                                </div>
                            </div>
                            <%--                          <div class="col-6 col-sm-4 col-lg-3 col-xl-3">
                                <div class="form-group">
            ...
            <asp:HiddenField ID="HfTimestamp_Customer" runat="server" Value="-1" />
            <asp:HiddenField ID="HfTimestamp_Proposal" runat="server" Value="-1" />
            ...
            <asp:HiddenField ID="hfCommOverridePermission" runat="server" Value="-1" />
            <asp:HiddenField ID="hfCommOverridechange" runat="server" Value="-1" />
            <asp:HiddenField ID="hdfPM" runat="server" Value="0" />
            <asp:HiddenField ID="hfCalendarFileNames" runat="server" Value="" />
        </ContentTemplate>
        <Triggers>
    ...
    <script type="text/javascript">
        ...
        function DDLName() {
            $('#<%=ddlBusinessDivision.ClientID%>').chosen();
            ...
            $('#<%=ddlThirdPartyInstallers.ClientID%>').chosen();
            $('#<%=ddlExistingJobID.ClientID%>').chosen();
            $('#<%=ddlCommRepOverride.ClientID%>').chosen();
            $('#<%=ddlInstallationStatus.ClientID%>').chosen();
            $('#<%=ddlInstallationAssTo.ClientID%>').chosen();
        }

        function ClickEventForPNumber_1(e) {
            __doPostBack('<%=btnExistingProposals_1.UniqueID%>', "");
        }
        ...
        function clamp100(el) {
            let v = parseInt(el.value.replace(/,/g, '')) || 0;
        ...
        function ResetConsultantRepDetails() {
            document.getElementById('lblFirstName').innerHTML = '';
            document.getElementById('lblAbb').innerHTML = '';
            document.getElementById('lblRepState').innerHTML = '';
            document.getElementById('lblPhoneMail').innerHTML = '';
            document.getElementById('lblPhone').innerHTML = '';
            document.getElementById('lblCellPhone').innerHTML = '';
            document.getElementById('lblFax').innerHTML = '';
        ...
        function ResetOriginationRepDetails() {
            document.getElementById('lblOrigFirstName').innerHTML = '';
            document.getElementById('lblOrigAbb').innerHTML = '';
            document.getElementById('lblOrigState').innerHTML = '';
            document.getElementById('lblOrigPhoneMail').innerHTML = '';
            document.getElementById('lblOrigPhone').innerHTML = '';
            document.getElementById('lblOrigCellPhone').innerHTML = '';
            document.getElementById('lblOrigFax').innerHTML = '';
            document.getElementById('lblOrigEmail').innerHTML = '';
            document.getElementById('lblOrigStatus').innerHTML = '';
        }
        ...
        function ResetDestinationRepDetails() {
            document.getElementById('lblDestFirstName').innerHTML = '';
            document.getElementById('lblDestAbb').innerHTML = '';
            document.getElementById('lblDestState').innerHTML = '';
            document.getElementById('lblDestPhoneMail').innerHTML = '';
            document.getElementById('lblDestPhone').innerHTML = '';
            document.getElementById('lblDestCellPhone').innerHTML = '';
            document.getElementById('lblDestFax').innerHTML = '';
            document.getElementById('lblDestEmail').innerHTML = '';
            document.getElementById('lblDestStatus').innerHTML = '';
        }
        ...
        function ResetDealerDetails() {
            document.getElementById('lblFederalID').innerHTML = '';
            document.getElementById('lblCompanyName').innerHTML = '';
            document.getElementById('lblGroupName').innerHTML = '';
            document.getElementById('lblStreetAddress').innerHTML = '';
            ...
            document.getElementById('lblTollFree').innerHTML = '';
            document.getElementById('lblTollFax').innerHTML = '';
            document.getElementById('lblDealerPhone').innerHTML = '';
            document.getElementById('lblDealerFax').innerHTML = '';
            document.getElementById('lblDealerRepName').innerHTML = '';
        }
        ...
        function ConsultantDetails() {
            document.getElementById('lblConsultantCompName').innerHTML = '';
            document.getElementById('lblConsultantStreetAdd').innerHTML = '';
            document.getElementById('lblConsultantCity').innerHTML = '';
            document.getElementById('lblConsultantCountry').innerHTML = '';
            document.getElementById('lblConsultantState').innerHTML = '';
            document.getElementById('lblConsultantPhone').innerHTML = '';
            document.getElementById('lblConsultantTollFree').innerHTML = '';
            document.getElementById('lblConsultantFax').innerHTML = '';
            document.getElementById('lblConsultantTollFax').innerHTML = '';
            document.getElementById('lblConsultantRepName').innerHTML = '';
        }
    ...
    function SetReviewByDropDown() {
        ...
        function EnabledDisabled() {
            var ddlCommReportOvrerride = document.getElementById('<%=ddlCommRepOverride.ClientID%>');
            document.getElementById('<%=txtCommReportOverrideReason.ClientID%>').value = "";
            if (ddlCommReportOvrerride.selectedIndex > 0) {
                document.getElementById('<%=txtCommReportOverrideReason.ClientID%>').disabled = false;
            }
            else {
                document.getElementById('<%=txtCommReportOverrideReason.ClientID%>').disabled = true;
            }
        }
        ...
        function checkDot(textbox) {
            if (textbox.value.trim() === ".") {
                textbox.value = "";
            }
        }

        function CheckFileValidations_CalendarEvent() {
            var fuUploadDoc_CalendarEvent = document.getElementById('<%= fuUploadDoc_CalendarEvent.ClientID %>');

            if (fuUploadDoc_CalendarEvent.files.length === 0) {
                return;
            }

            const MAX_SIZE = 5000 * 1024; // 5000 KB
            const ALLOWED_EXTENSIONS = ["pdf", "doc", "docx", "xls", "xlsx"];

            for (let i = 0; i < fuUploadDoc_CalendarEvent.files.length; i++) {
                var file = fuUploadDoc_CalendarEvent.files[i];
                ...
                if (ALLOWED_EXTENSIONS.indexOf(extension) === -1) {
                    ...
                    fuUploadDoc_CalendarEvent.value = "";
                    return;
                }

                if (file.size > MAX_SIZE) {
                    toastr.error(file.name + " exceeds 5000 KB.", "", {
                        timeOut: 5000,
                        hideDuration: 100,
                        closeButton: true
                    });
