...
<asp:Content ID="Content_Projects_Eng" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel_Projects_Eng" runat="server">
        <ContentTemplate>
                ...
                <div class="row bg-white shadow-sm border-bottom">
                    <div class="col">
                        <ul class="nav nav-tabs customTabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item border-right" role="presentation" style="display: none;">
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-8 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Upload Plan View (PDF Max 1500 kb Size)</label>
                            ...
                            <div class="col-6 col-sm-8 col-md-4 col-lg-4">
                                <div class="form-group mb-0">
                                    <label for="chkTempStatus">Temp. Status</label>
                                    <div class="form-check">
                                        <asp:CheckBox ID="chkTempStatus" runat="server" Text="&nbsp;On Hold" CssClass="form-check-input" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade pt-2" id="fabTab" role="tabpanel" aria-labelledby="fabrication-tab">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <asp:Button runat="server" ID="btnRedirectMonthlyReport" CssClass="btn btn-success btn-sm mb-3" Text="Monthly Report" OnClick="btnRedirectMonthlyReport_Click" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row border-top">
                            ...
                            <div class="col-6 col-sm-8 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label>Upload Doc. (PDF Max 500 kb Size)</label>

                                    <div class="d-flex align-items-center gap-2">
                                        <asp:FileUpload ID="fuUploadDoc" runat="server"
                                            CssClass="btn btn-success btn-sm" Style="width: 300px"
                                            onchange="CheckFileValidations_FabTask()" />

                                        <asp:Button ID="btnDeleteFabFile" runat="server"
                                            CssClass="btn btn-danger btn-sm ml-1"
                                            Text="Delete File" Visible="false"
                                            OnClientClick="return confirm('Are you sure to delete.?');"
                                            OnClick="btnDeleteFabFile_Click" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:Button runat="server" ID="btnCancelFabricationTask" CssClass="btn btn-danger btn-sm" Text="Cancel" OnClick="btnCancelFabricationTask_Click" />
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView CssClass="table mainGridTable table-sm mb-0" ForeColor="White" ID="gvFabricationCanada" runat="server" AutoGenerateColumns="false" DataKeyNames="id"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="File Name (Download)">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkFabFile" runat="server" CausesValidation="false" Text='<%# Eval("FileName") %>' OnClientClick="openInNewTab();" CommandName="DownloadFile"></asp:LinkButton>
                                                    <asp:Label ID="lblFabFileName" runat="server" Text='<%# Eval("FileName") %>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <div class="tab-pane fade pt-2" id="fabChinaTab" role="tabpanel" aria-labelledby="fabricationChina-tab">
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group chosenFullWidth">
                                    ...
                                    <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlDestinationFacility" runat="server" DataTextField="text" DataValueField="id"
                                        OnSelectedIndexChanged="ddlDestinationFacility_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>                            
                        ...
                        <div class="row border-top pt-2">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Ex. Arrival Date In Canada</label>
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                <div class="form-group">
                                    <label>Arrival Date In Canada</label>
                                    <asp:TextBox CssClass="form-control form-control-sm" ID="txtArrivalCanada" AutoComplete="off" runat="server" OnBlur="validateDate(this)"></asp:TextBox>
                                    <asp:CalendarExtender ID="txtArrivalCanada_Extender" runat="server" Format="MM/dd/yyyy"
                                        PopupButtonID="txtArrivalCanada" TargetControlID="txtArrivalCanada">
                                    </asp:CalendarExtender>
                                </div>
                            </div>
            ...
            <asp:ModalPopupExtender ID="ModalPopupExtender_Confirmation" runat="server" TargetControlID="lnkConfirmationModalButton"
                PopupControlID="pnConfirmationPanel" BackgroundCssClass="modalBackground" CancelControlID="btnClose">
            </asp:ModalPopupExtender>
            <asp:Panel ID="pnConfirmationPanel" runat="server" CssClass="ReportsModalPopup" Style="display: none" Width="40%">
                    ...
                    <div class="overflow-auto h-100">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <h5 class="text-uppercase">Since No Tasks are assigned to Nesting, Are you sure you want to Release <%=HfJObID.Value %>
                                        to the Shop.?                                  
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <asp:Button ID="btnYes" runat="server" CssClass="btn btn-success btn-sm" Text="Yes" OnClick="btnYes_Click" />
                                        <asp:Button ID="btnNo" runat="server" CssClass="btn btn-primary btn-sm" Text="No" OnClick="btnNo_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <asp:LinkButton ID="lnkConfirmationModalButton" runat="server"></asp:LinkButton>

            <asp:HiddenField ID="HfTimestamp_FabricationTasks" runat="server" Value="-1" />
            ...
            <asp:HiddenField ID="hfFabTask_FileName" runat="server" Value="" />
        </ContentTemplate>
        <Triggers>
            <asp:PostBackTrigger ControlID="btnSave" />
            <asp:PostBackTrigger ControlID="btnAddFabricationTask" />
            ...
            <asp:PostBackTrigger ControlID="gvFabricationCanada" />
        </Triggers>
    </asp:UpdatePanel>
    <script type="text/javascript">
        ...
        function DDLName() {
            ...
            $('#<%=ddlDestinationFacility.ClientID%>').chosen();
        }
        ...
        function ConfirmationReleaseWarning(job) {
            var message = "";
            message = "Since No Tasks are assigned to Nesting, Are you sure you want to Release " + job + " to the Shop.? ";
        ...
        function CheckFileValidations() {
            ...
            if (file.size > MAX_FILE_SIZE) {
                var filesize = "File size exceeds 1500 KB. Please upload a smaller file.";
        ...
        function CheckFileValidations_FabTask() {
            var fuUploadDoc = document.getElementById('<%= fuUploadDoc.ClientID %>');
            var file = fuUploadDoc.files[0];
            ...
            // Check file size
            if (file.size > MAX_FILE_SIZE) {
                var filesize = "File size exceeds 500 KB. Please upload a smaller file.";
                toastr.error(filesize, '', { 'timeOut': 5000, 'hideDuration': 100, 'closeButton': true });
                fuUploadDoc.value = '';
                return;
            }
