    ...
    <asp:UpdatePanel ID="UpdatePanel_SalesActivity" runat="server">
        <ContentTemplate>
                        ...
                        <div class="col-12">
                                ...
                                <div class="col-3">
                                    <div class="form-group chosenFullWidth">
                                        ...
                                        <asp:DropDownList ID="ddlTypeOfContact" runat="server" CssClass="form-control form-control-sm">
                                            ...
                                            <asp:ListItem Value="I">In-Person Meeting</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="col-12 border-top" id="divFollowupSection" runat="server">
                                <div class="row">
                                    ...
                                    <%--<div class="col-12">--%>
                                    <div class="table-responsive">
                                        <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvFollowups" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,TimeStamp"
            ...
            <asp:HiddenField ID="hfTimeStamp" runat="server" Value="-1" />
             <asp:HiddenField ID="hfTimeStampFollowUps" runat="server" Value="-1" />
        </ContentTemplate>
        <%--<Triggers>
