...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="row">
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label>JobID</label>
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtJNumber" AutoComplete="off" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtInvoiceNo" AutoComplete="off" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-4 col-lg-2">
                        <div class="form-group">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group chosenFullWidth">
                            <label>Release to Shop</label>
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlReleaseToShop" runat="server">
                                <asp:ListItem Value="">All</asp:ListItem>
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-12 col-sm-4 col-md-3 col-lg-9">
                                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function DDL() {
            ...
            $('#<%=ddlMfacility.ClientID%>').chosen();
            $('#<%=ddlBusinessDivision.ClientID%>').chosen();
            $('#<%=ddlReleaseToShop.ClientID%>').chosen();
