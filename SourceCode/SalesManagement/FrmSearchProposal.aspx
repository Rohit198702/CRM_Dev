                ...
                <div class="row">
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label>PNumber</label>
                            <asp:TextBox CssClass="form-control form-control-sm" ID="txtPNumber" AutoComplete="off" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlConsultant" runat="server" DataTextField="CompanyName" DataValueField="ConsultantID" AutoPostBack="true" OnSelectedIndexChanged="ddlConsultant_SelectedIndexChanged"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            <label>Consultant Member</label>
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlConsultantMember" runat="server" DataTextField="text" DataValueField="id"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlDealerMember" runat="server" DataTextField="text" DataValueField="id"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-4">
                        <div class="form-group srRadiosBtns">
                            ...
                            <asp:RadioButtonList ID="rdbOrderForProposal" runat="server" RepeatDirection="Horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="form-group mb-0">
                                    <label for="chkTempStatus">&nbsp;</label>
                                    <div class="form-check">
                                        <asp:CheckBox ID="chkExactMatch" runat="server" Text="&nbsp;Exact Match" CssClass="form-check-input" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12" style="overflow-x: auto; max-height: 400px; overflow-y: auto;">
                        <asp:GridView ID="gvProposalSearch" runat="server" AutoGenerateColumns="False" Visible="false" BackColor="White" BorderColor="#999999" BorderStyle="Solid"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ConsultantMember" HeaderText="Consultant Member" SortExpression="ConsultantMember">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="DealerMember" HeaderText="Dealer Member" SortExpression="DealerMember">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField>
