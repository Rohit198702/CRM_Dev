                ...
                <div class="row" style="overflow-x:auto;">
                    <div class=" col">
                        <asp:GridView ID="gvProposalSearch" runat="server" AutoGenerateColumns="False" Visible="False" BorderStyle="Solid" 
                            BorderWidth="1px" CellPadding="3" DataKeyNames="PNumber" EnableModelValidation="True" ForeColor="Black" GridLines="Vertical" 
                            ...
                            Style="font-size: small" AllowSorting="True" AllowPaging="true" OnPageIndexChanging="gvProposalSearch_PageIndexChanging" 
                            OnSorting="gvProposalSearch_Sorting" BackColor="White" BorderColor="#999999" OnRowCreated="gvProposalSearch_RowCreated"
                            OnDataBound="gvProposalSearch_DataBound" >
                            ...
                            <nav>
                                <div class="col-4 d-flex align-items-center flex-nowrap" id="ddlShowRecordsSize" runat="server" visible="false">
