    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server">
        <ContentTemplate>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtIssueDescription" CssClass="form-control form-control-sm" runat="server" TextMode="MultiLine" oninput="return limitMultiLineInputLength(this, 1000)"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtRootCause" CssClass="form-control form-control-sm" runat="server" TextMode="MultiLine" oninput="return limitMultiLineInputLength(this, 1000)"></asp:TextBox>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtInitialActionTaken" CssClass="form-control form-control-sm" runat="server" TextMode="MultiLine" oninput="return limitMultiLineInputLength(this, 1000)"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtCorrectiveAction" CssClass="form-control form-control-sm" runat="server" TextMode="MultiLine" oninput="return limitMultiLineInputLength(this, 1000)"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtPreventiveAction" CssClass="form-control form-control-sm" runat="server" TextMode="MultiLine" oninput="return limitMultiLineInputLength(this, 1000)"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtComments" CssClass="form-control form-control-sm" runat="server" TextMode="MultiLine" oninput="return limitMultiLineInputLength(this, 1000)"></asp:TextBox>
                        </div>
                    </div>
            ...
            <asp:HiddenField ID="hfDetailId" runat="server" Value="-1" />
             <asp:HiddenField ID="hfTimeStampMain" runat="server" Value="-1" />
