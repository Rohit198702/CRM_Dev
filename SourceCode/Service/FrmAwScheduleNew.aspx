                    ...
                    <div class="row pt-3">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtReleaseDate" CssClass="form-control form-control-sm" AutoComplete="off" runat="server" OnBlur="validateDate(this)"></asp:TextBox>
                    ...
                    <div class="row pt-3">
                        <div class="col-12">
                            <div class="table-responsive">
                                <asp:GridView CssClass="table mainGridTable table-sm mb-0" ID="gvSummary" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,TimeStamp"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Part Desc.*">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtPartDesc" MaxLength="250" runat="server" TextMode="MultiLine" Text='<%# Eval("PartDescription") %>' class="form-control form-control-sm" oninput="return limitMultiLineInputLength(this, 250)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtFooterPartDesc" MaxLength="250" TextMode="MultiLine" runat="server" Text='<%# Eval("PartDescription") %>' class="form-control form-control-sm" oninput="return limitMultiLineInputLength(this, 250)"></asp:TextBox>
                                            </FooterTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Required Ship date*">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtReqShipDate" runat="server" Text='<%# Eval("ReqShipDate") %>' class="form-control form-control-sm" OnBlur="validateDate(this)"></asp:TextBox>
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtReqShipDateFooter" runat="server" Text='<%# Eval("ReqShipDate") %>' class="form-control form-control-sm" OnBlur="validateDate(this)"></asp:TextBox>
                                                <asp:CalendarExtender ID="CalendarExtendergvSummDate" runat="server" Format="MM/dd/yyyy"
                                        ...
                                        <asp:TemplateField HeaderText="Part Req On Site">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtPartReqOnSite" runat="server" Text='<%# Eval("PartReqOnSite") %>' class="form-control form-control-sm" OnBlur="validateDate(this)"></asp:TextBox>
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtPartReqOnSiteFooter" runat="server" Text='<%# Eval("PartReqOnSite") %>' class="form-control form-control-sm" OnBlur="validateDate(this)"></asp:TextBox>
                                                <asp:CalendarExtender ID="CalendarExtendergvSummDate_1" runat="server" Format="MM/dd/yyyy"
                                        ...
                                        <asp:TemplateField HeaderText="Ship Date">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtShipDate" runat="server" Text='<%# Eval("ShipDate") %>' class="form-control form-control-sm" OnBlur="validateDate(this)"></asp:TextBox>
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtShipDateFooter" runat="server" Text='<%# Eval("ShipDate") %>' class="form-control form-control-sm" OnBlur="validateDate(this)"></asp:TextBox>
                                                <asp:CalendarExtender ID="CalendarExtendergvSummDate_2" runat="server" Format="MM/dd/yyyy"
