<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="FrmSheetForecasting.aspx.cs" Inherits="SheetMetalForecasting_FrmSheetForecasting" %>
                ...
                <div class="row">
                    <div class="col-12 pt-2">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">Stock Forecasting</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <asp:GridView BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ...
                                ID="GvSheetForecasting" runat="server" AutoGenerateColumns="true" CssClass="table mainGridTable table-sm"
                                EnableModelValidation="True" OnRowDataBound="GvSheetForecasting_RowDataBound" OnRowCreated="GvSheetForecasting_RowCreated">
