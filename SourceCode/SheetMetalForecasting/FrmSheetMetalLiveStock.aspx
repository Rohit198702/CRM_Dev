<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="FrmSheetMetalLiveStock.aspx.cs" Inherits="SheetMetalForecasting_FrmSheetMetalLiveStock" %>
                ...
                <div class="row">
                    <div class="col-12 pt-2">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h4 class="title-hyphen position-relative">Live Sheet Metal Stock Forecasting</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <asp:GridView BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"
                                ...
                                ID="gvJobSheetLiveStock" runat="server" AutoGenerateColumns="true" CssClass="table mainGridTable table-sm"
