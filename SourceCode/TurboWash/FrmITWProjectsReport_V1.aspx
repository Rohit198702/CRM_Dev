...
<asp:Content ID="Content_ITWProjectsReport" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label>PO#</label>
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlPONumber" runat="server" DataTextField="text" DataValueField="text">
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <asp:DropDownList CssClass="form-control form-control-sm" ID="ddlDateFilterOn" runat="server" OnSelectedIndexChanged="ddlDateFilterOn_SelectedIndexChanged" AutoPostBack="true">
                                <asp:ListItem Value="1">PO Received Date</asp:ListItem>
                                <asp:ListItem Value="2">Ship Date</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 pl-0">
                        <div class="form-group">
                            ...
                            <div class="col-auto">
                                ...
                                <asp:Button ID="btnGenerateExcel" runat="server" CssClass="btn btn-info btn-sm" CausesValidation="false" OnClientClick="window.document.forms[0].target='_blank';" Text="Export to Excel" OnClick="btnGenerateExcel_Click" />
    ...
    <script type="text/javascript">
        ...
        function DDL() {
            ...
            $('#<%=ddlDateFilterOn.ClientID%>').chosen();
