        ...
        <ContentTemplate>
            ...
            <div class="col-12 border-top">
                <div class="row pt-3">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label class="text-danger">PO#*</label>
            ...
            <div class="col-12 border-top" style="display: none;">
                <div class="row pt-3">
                    <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtShipmentShipDate" autocomplete="off" CssClass="form-control form-control-sm" runat="server" OnBlur="validateDate(this)"></asp:TextBox>
                                ...
                                <div class="col-3 d-flex align-items-center" style="display: none !important;">
                                    <div class="form-group mb-0">
                                        <div class="input-group input-group-sm d-flex align-items-center">
                                            <div class="input-group-prepend pr-3">Release to Nesting</div>
                                            <asp:CheckBox ID="chkReleaseToNesting_Shipment" runat="server" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <asp:GridView ID="gvShipmentHistory" runat="server" AutoGenerateColumns="False" BorderStyle="Solid" EmptyDataText="No Records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Release" HeaderText="Released To Production">
                                                <ItemStyle HorizontalAlign="Left" Width="8%" />
                                            </asp:BoundField>

                                            <asp:BoundField DataField="ReleaseToNesting" HeaderText="Release To Nesting">
                                                <ItemStyle HorizontalAlign="Left" Width="8%" />
                                            </asp:BoundField>

                                            <asp:TemplateField HeaderText="Modify" ItemStyle-Width="20%">
                                                <ItemTemplate>
                                                    <div style="text-align: center;">
                                                        ...
                                                        <asp:LinkButton CssClass="btn btn-success btn-sm" title="Release To Nesting" runat="server" Text="Release to Nesting" CommandName="ReleaseToNesting" OnClientClick="return confirm('Are you sure.?');">
                                                            <i class="far fa-paper-plane" title="Send To Nesting"></i>
                                                        </asp:LinkButton>
